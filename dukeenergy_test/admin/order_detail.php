...
if(!$page || $page==1){
	...
	print("<br>");
	$ID=$_GET['ID'];
	$sql="select * from tblOrdersCompleted_1 where completeID='$ID'";
	$result=db_query($sql);
	...
	if(!$count){
		...
		while($row=mysql_fetch_array($result)){
			...
			print("<td><span class=\"body_content\">$".$ship."</span></td>\n");
			print("</tr>\n");
			print("<tr valign=\"top\">");
			...
			$sql2="select * from tblotsdetail_1 where otsID='$otsID'";
