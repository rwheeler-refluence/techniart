...
<html>
<head>
<title>TechniArt -- Duke Webstore Orders</title>
...
<td><span class="title_main_sub">Current Orders:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
if(!$page || $page==1){
	...
	print("<br>");
	$sql="select * from tblOrdersCompleted_1 order by completeID desc";
	$result=db_query($sql);
