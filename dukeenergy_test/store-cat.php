...
while($rowp=mysql_fetch_array($resultp)){
	...
	$modelNumber=$rowp['modelNumber'];
			//$loc=$rootDir."dukeenergy_test/pix/products/thumbnails/".$imageLoc;
			$loc="https://images.techniart.us/dukeenergy/pix/products/thumbnails/".$imageLoc;


?>
<td width="24%">
<form method="post" action="https://www.techniart.us/dukeenergy_test/cart.php">
