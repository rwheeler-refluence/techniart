...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js"></script>
<link rel="stylesheet" type="text/css" href="https://www.techniart.us/dukeenergy/js/shadowbox.css">
<script type="text/javascript" src="https://www.techniart.us/dukeenergy/js/shadowbox.js"></script>
<script type="text/javascript">
Shadowbox.init();
</script>
<meta charset="utf-8">
...
</head><?php include_once("analyticstracking1.php") ?><?php include("nav-lto.php") ?>
<BODY>
<center><div class="gridContainer clearfix"><div id="LayoutDiv1">
<?php include_once("header-order.php") ?>
...
if(!$count){
	...
	print("<center><span class=\"cart\"><b>Your shopping cart contains the following:</b><br /><br>\n");
	...
	while($row=mysql_fetch_array($result)){
		...
		print("<td align=\"center\"><input type=\"button\" value=\"Go Back\" onClick=\"location.href='cart-lto.php'\" class=\"btn2\"></td>\n");
...
<form name="form1" id="form1" method="post" action="confirm_pre-lto.php" onSubmit="return fVerifyResForm();"><input type="hidden" name="otsID" value="<? echo($o);?>">
...
<?}?>
  ...
  <?php include("footer-orderform.php") ?>
</center>
</body>
</html>
