...
<html>
<head>
<title>TechniArt -- Raytheon Orders</title>
...
<td><span class="title_main_sub">Raytheon Orders:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
if(!$page || $page==1){
	...
	print("<br>");
	$sql="select * from tblOrdersCompleted_raytheon order by completeID desc";
	$result=db_query($sql);
