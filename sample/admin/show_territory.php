...
<?
		$sql="select tblTerritory.territoryID,tblTerritory.zip,tblTerritory.vendor,tblVendors.vendorName from tblTerritory asc";
		$result=db_query($sql);
		...
		print("<td><span class=\"body_content\">".$territoryID."</span></td>");
