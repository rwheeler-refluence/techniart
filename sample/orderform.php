...
if(!$count){
	...
	while($row=mysql_fetch_array($result)){
		...
		print("<td align=\"center\"><input type=\"button\" value=\"Go Back\" onClick=\"location.href='http://www.techniart.us/Cambridge/cart.php'\" class=\"btn2\"><br /><img src=\"pix/pix_trans.gif\" height=\"1\"><br /><input type=\"button\" class=\"btn2\" value=\"Remove\" onClick=\"location.href='remove.php?ID=".$otsdetailID."'\"></td>\n");
...
<center><div align="center"><span class="body_content_ip"> <br>
  ORDERS WILL ONLY BE SHIPPED TO EVERSOURCE ENERGY CUSTOMERS IN CAMBRIDGE.<br>
  <br>
</div>
