...
if($countdis>0){
	...
	while($rowdis=mysql_fetch_array($resultdis)){
		...
		$vendor=$rowdis['vendor'];
			$loc=$rootDir."ues/pix/logos/".$vendorLogo;
			if(file_exists($loc)){
...
<br /><br /><img src="pix/ship.jpg" width="300" height="50" />
<form></form>
...
<td colspan="3" style="padding-left:30px;"><span class="body_content_style1"><i>Please enter your 5 digit zip code.<br></span></td>
</tr></table>

</div></div></td>
<td width="347"><div id="main_content_zip-callout_ip">
<br /><img src="pix/ship.jpg" width="300" height="50" />
