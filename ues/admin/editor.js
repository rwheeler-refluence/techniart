...
this.width =  "auto";
this.height = "auto";
this.bodyStyle = 'background-color: #FFFFFF; font-family: "arial"; font-size: 11pt;';
...
this.btnList = {
    ...
    "custom1":           ['custom1',         'Add a Single Line Break',  'editor_action(this.id)',  'ed_custom.gif'],
...
function editor_action(button_id) {
  ...
  // Custom1
    ...
    alert("To achieve a single line break, press SHIFT + ENTER.  Pressing Enter will result in a double line break.");
  }
