...
<td width="906" class="title_bkg"><div id="title_spacer" align="left"><span class="title_main">Product Categories </span></div></td>
</tr></table>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$modelNumber=$rowp['modelNumber'];
			$loc=$rootDir."ues/pix/products/thumbnails/".$imageLoc;
			if(!file_exists($loc)){
				$loc=$rootDir."ues/pix/products/".$imageLoc;
				$folder="ues/pix/products/";
			}else{
...
?>
<td width="275">
<form method="post" action="http://www.techniart.com/ues/cart.php">
