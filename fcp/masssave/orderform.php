...
ORDERS WILL ONLY BE SHIPPED TO RESIDENTIAL ELECTRIC CUSTOMERS OF PARTICIPATING MASS SAVE SPONSORS.<br>
  ...
  <td align="left"><input name="account" id="account" type="text" size="25" value="" class="forms10"></td>
            ...
            <td height="5"></td>
                    ...
                    <tr valign="top"><td height="39" align="left"><span class="cart">What's your primary motivation for using a room air cleaner?</span></td>
            <td valign="middle" align="left"><select name="question1" class="forms10">
             <option></option>
              <option value="Seasonal allergies">Seasonal allergies</option>
               <option value="Household odors">Household odors</option>
                <option value="Pet dander">Pet dander</option>
                <option value="Dust">Dust</option>
                <option value="General indoor air quality">General indoor air quality</option>
          ...
          <tr valign="top">
            <td height="5"></td>
                    ...
                    <tr valign="top"><td height="39" align="left"><span class="cart">Do you rent or own your home?</span></td>
