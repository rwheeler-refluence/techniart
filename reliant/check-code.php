...
<?
$coupon=$_POST['coupon'];
$sql1="select * from tblCoupon_reliant where code='$coupon'";
#print("".$sql."<br>");
...
#print $otsID;	
$sqlincoup="UPDATE tblotsdetail_reliant set coupon='$coupon' WHERE otsID='$otsID'";
$resultcoup=mysql_query($sqlincoup);
}else{
if($countcoupon>0 && $status==3){
$_SESSION['coupon']='';
echo "<SCRIPT LANGUAGE='JavaScript'>
        window.alert('That coupon code has expired.')
		window.location.href='cart.php'
        </SCRIPT>";
}else{
