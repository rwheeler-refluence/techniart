...
switch($action){
	case "add":
		...
		$sqlc="select * from tblorderstosend_reliant where sess='$sess' && status='open'";
		...
		$_SESSION['otsID']=$next;
		#add item to cart
		$sqli="select * from tblotsdetail_reliant where itemNo='$itemNo' && otsID='$next'";
		#print("".$sqli."<br />");
		$resulti=db_query($sqli);
		$counti=mysql_num_rows($resulti);
		if(!$counti){
			$sql2="insert into tblotsdetail_reliant values ('','$next','$itemNo','$quantity','$price','$desc')";
		}else{
			...
			$sql2="update tblotsdetail_reliant set qty='$newqty' where otsdetailID='$otsdetailID'";
		}
#		print($sql2);
...
&nbsp;&nbsp;Order Form </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style4"><strong>Get $7 flat rate shipping</strong> on all orders over $15!</span></div></td>
</tr></table>
...
$sql="select * from tblotsdetail_reliant where otsID='$o'";
$result=db_query($sql);
...
#	}else{
	...
	$ship=number_format($shiprate, 2, '.', ',');
		print("<td align=\"left\"><span class=\"body_content_style1\">$".$ship."</span></td>\n");
	print("</tr>\n");}
	if ($carttot >=15 && $_SESSION['coupon'] && $_SESSION['rep']=="CNP"){
		print("<tr bgcolor=\"#FFFFFF\">\n");
	print("<td colspan=\"4\" align=\"right\"><span class=\"body_content_style1\"><b>Shipping:</b>&nbsp;</span></td>\n");
	$shiprate=0;
	$ship=number_format($shiprate, 2, '.', ',');
		print("<td align=\"left\"><span class=\"body_content_style1\">$".$ship."</span></td>\n");
	print("</tr>\n");}
	if ($carttot >=15 && $_SESSION['coupon'] && $_SESSION['rep']=="AEP"){
		print("<tr bgcolor=\"#FFFFFF\">\n");
	print("<td colspan=\"4\" align=\"right\"><span class=\"body_content_style1\"><b>Shipping:</b>&nbsp;</span></td>\n");
	$shiprate=7;
	$ship=number_format($shiprate, 2, '.', ',');
		print("<td align=\"left\"><span class=\"body_content_style1\">$".$ship."</span></td>\n");
	print("</tr>\n");}
if ($carttot >=15 && $_SESSION['coupon'] && $_SESSION['rep']=="NQ"){
		print("<tr bgcolor=\"#FFFFFF\">\n");
	print("<td colspan=\"4\" align=\"right\"><span class=\"body_content_style1\"><b>Shipping:</b>&nbsp;</span></td>\n");
	$shiprate=7;
	$ship=number_format($shiprate, 2, '.', ',');
		print("<td align=\"left\"><span class=\"body_content_style1\">$".$ship."</span></td>\n");
	print("</tr>\n");}
	if ($carttot >=15 && $_SESSION['coupon'] && $_SESSION['rep']==''){
		print("<tr bgcolor=\"#FFFFFF\">\n");
	print("<td colspan=\"4\" align=\"right\"><span class=\"body_content_style1\"><b>Shipping:</b>&nbsp;</span></td>\n");
	$shiprate=7;
	$ship=number_format($shiprate, 2, '.', ',');
...
<div align="left"><span class="body_content_style1">*Please note: Sales tax will not be charged when shipping to Texas <br>
  If your order is under $15, you will be charged the standard UPS rate (~$13-$20) on the next page.<br>
  If you order is over $15, you will be charged the $7 flat rate shipping.
  <br>
</span></div>
<br>
