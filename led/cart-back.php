...
if(!$count){
	print("<br><p align=\"center\"><b>Only 3 LED 6-packs per UGI residential electric account (18 total bulbs).</b></p><br />\n");
...
print("<td align=\"center\"><input type=\"submit\" value=\"Update\" onClick=\"this.form.submit();\" class=\"btn1\"></td></form></tr>\n");
		...
		print("<td></td>\n");
 	 	print("<td></td>\n");
			print("<td></td>\n");
		print("<td align=\"center\"><form method=\"post\" action=\"https://www.techniart.com/ugi1/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Checkout\" class=\"btn1\">");
		print("</tr>\n");
		print("<tr><td><br></td></tr>\n");
		print("</table></form>\n");
}	?>
