...
<!--<![endif]-->
<head>
<title>Mass Save Smarter Living Kit Promo - THANK YOU</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="760_livingroom-thanks.jpg" usemap="#MapMap" border="0">
      <map name="MapMap">
        <area id="share2" shape="rect" coords="326,225,434,256" href="#" onClick="javscript:window.open('share.php','popup2a','scrollbars=no, resizeable=no,width=450,height=100,screenY=450,top=40, left=420');" alt="Facebook Share">
      </map></td></tr>
</table>
<table width="85%" border="0">
  <tr>
    <td width="100%" height="50" valign="middle"><div align="center"><span class="cart">Your order has been successfully processed. <br>
<br>
You will receive an email receipt from TechniArt and from our payment gateway, Bluepay, confirming your order.</span><br />
</div></td>
    </tr>
  <tr>
    <td height="54" valign="middle"><div align="center"><span class="cart">Please do not click the back button as you may mistakenly place a duplicate order.</span><br>
    </div></td>
    </tr>
  <tr>
    <td height="35" valign="middle"><div align="center">
      <span class="link"><? print $message;?></span>
