...
#	print("weight: ".$weight."<br>");
	...
	print("</tr>\n");
		...
		$sqltax="SELECT zip, MIN(tax) from tblTerritory where zip=".$ship_zip." GROUP BY zip";
	...
	print("<td style=\"padding-left:4px;\"><span class=\"cart\">$".$shipformat."");
...
<table width="100%">
  <tr valign="top">
    <td align="left"><span class="cart-header">Shipping Address:</span></td>
  </tr>
  <tr valign="top">
    <td align="left"><span class="cart"><? echo($ship_fname); ?> <? echo($ship_lname); ?></span><br>
  ...
  <tr valign="top">
    <td align="left"><span class="cart"><strong>Name on card:</strong> <? echo($firstName); ?> <? echo($lastName); ?></span><br>
      ...
      <span class="cart"><b>Special instructions:</b> <? echo($instr); ?></span></td>
        ...
        <tr valign="top">
<td colspan="2" align="center"><br><div align="center"><input type="hidden" name="amount" value="<? echo($totformat); ?>"><input type="button" class="btn" value ="Place Order" onClick="this.form.submit();" /></div><br><strong class="cart">Please click the Place Order button once to avoid duplicate charges.</strong></span></td>
</tr></table></form>
<?}?>
