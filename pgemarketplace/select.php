...
<title>Special offer from PGE</title>
</head>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$loc="http://www.techniart.us/pgemarketplace/pix/products/thumbnails/".$imageLoc;
?>
<td>
...
<td width="340">
<form method="post" action="https://www.techniart.us/pgemarketplace/cart.php">
