...
$subject="Mass Save RAC Order - techniart.com";
$headers = "From: " . $from . "\r\n";
$headers .= "BCC: ". $bcc . "\r\n";
...
Mass Save’s Save Smart Bathroom Kit offer is available from Friday, January 22nd 2016 through Sunday, January 31st, 2016. All orders will be processed, packed and shipped after the promotion has ended. We will send out a verification email when we begin shipping. All orders should be delivered no later than Friday, February 12th.
...
TechniArt & Mass Save\n";
		...
		mail($to=$email,$subject="Thank you for your Mass Save Save Smart Bathroom Kit order from techniart.com",$body,"From:".$from."");
		}
print("<pre>");
print($body);
print("</pre>");
