...
$sql="select distinct category from tblProducts_copy order by category asc";
$result=db_query($sql);
...
<span class="section_heading_style1">Look for discounted prices provided by</span><br>
    <span class="product_title_lg">Champion Energy Services</span>.<br />
    <br />
  </td>
  <td width="372" rowspan="2" valign="middle"><div id="style3">
    <div align="center"><span class="style3"><strong>Get $7 flat rate shipping</strong><br />
      on all orders over $15!</span><br /><br /><span class="product_price">Limit of 48 bulbs per purchase.<br />
        </span></div>
  </div></td>
</tr>
  <tr valign="top">
...
<? if($countzip<1){echo "<SCRIPT LANGUAGE='JavaScript'>
		...
		window.location.href='http://www.techniart.us/ces/index.php'
        </SCRIPT>";}}?>