...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?
$o=$_SESSION['otsID'];
$sql="select * from tblotsdetail_illumina LEFT OUTER JOIN tblProducts on tblotsdetail_illumina.itemNo=tblProducts.productID where tblotsdetail_illumina.otsID='$o'";
$combo="select qty as ComboQuantity from tblotsdetail_illumina where tblotsdetail_illumina.itemNo='242' && tblotsdetail_illumina.otsID='$o'";
$br="select qty as BRQuantity from tblotsdetail_illumina where tblotsdetail_illumina.itemNo='243' && tblotsdetail_illumina.otsID='$o'";
$comboup="update tblotsdetail_illumina set qty='5' where tblotsdetail_illumina.itemNo='242' && tblotsdetail_illumina.otsID='$o'";
$brup="update tblotsdetail_illumina set qty='6' where tblotsdetail_illumina.itemNo='243' && tblotsdetail_illumina.otsID='$o'";
#print($sql);
#print($sql);
$result=db_query($sql);
...
while($row=mysql_fetch_array($resultbr)){
	...
	$wek="select qty as WEKQuantity from tblotsdetail_illumina where tblotsdetail_illumina.itemNo='244' && tblotsdetail_illumina.otsID='$o'";
$wekup="update tblotsdetail_illumina set qty='1' where tblotsdetail_illumina.itemNo='244' && tblotsdetail_illumina.otsID='$o'";
...
if ($brlimit>6){
	...
	echo "<SCRIPT LANGUAGE='JavaScript'>
        window.alert('You may only purchase 6 of the BR30 3-packs per household!')
		window.location.href='cart.php'
        </SCRIPT>
        ";
}	
...
if(!$count){
	...
	print("<p align=\"center\"><input type=\"button\" class=\"btn\" value=\"Start Over\" onclick=\"location.href='http://www.techniart.com/illumina/index.php'\">\n");
	print("</tr>\n");
}else{
...
print("<table align=\"center\" width=\"90%\" cellpadding=\"1\" cellspacing=\"1\">\n");
 ...
 while($row=mysql_fetch_array($result)){
	...
	/*	if(strlen($_SESSION['zip_qualify'])>0){
			$pr=$row['disct_price'];
			if($pr!==$price){
			$sqlu="update tblotsdetail_illumina set price='$pr' where otsdetailID='$otsdetailID'";
...
#	print("</tr>\n");
	...
	print("<tr>\n");
	if($combolimit<1){
	print("<td colspan=\"3\" align=\"right\"><form method=\"post\" action=\"adda19.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Add A19 5-Pack\" class=\"btn1\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
	print("</tr></form>\n");}
		if($brlimit<1){
	print("<td colspan=\"3\" align=\"right\"><form method=\"post\" action=\"addbr30.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Add BR30 3-pack\" class=\"btn1\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
	print("</tr></form>\n");}
	print("<tr>\n");
	if($totformat<1){	print("<td colspan=\"3\" align=\"right\"><form method=\"post\" action=\"https://www.techniart.com/sdgewaterenergykit\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Checkout\" class=\"btn1\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
	}else{
