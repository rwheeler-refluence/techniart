...
<table width="100%" border="0">
  <tbody>
   <tr><td colspan="2" align="center"><br><span class="cart">Please select your APS quantity and then click Add to Cart</span></td></tr>
    <tr valign="top">
      <td width="100%">
...
<tr ><td>
<ul>
<li style="margin-left: 40px">Class-leading data processing power</li>
<li style="margin-left: 40px">Active Powerdown for PC and peripherals</li>
<li style="margin-left: 40px">Power sensing for reliable control</li>
<li style="margin-left: 40px">Auto-adjusts to all desktop and laptop devices</li>
<li style="margin-left: 40px">Adjustable active standby timer control</li>
<li style="margin-left: 40px">Surge protection (1,530 Joules)</li></ul>
