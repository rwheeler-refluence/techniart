...
<? $source=$_POST['source'];?>
<form name="form1" id="form1" method="post" action="https://www.techniart.us/sdgeenergysolutionspartners/confirm.php" onSubmit="return fVerifyResForm();">
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<table width="90%" border="0" align="center">
  <tr>
    <td valign="top"><table width="91%"  align="center" border="0" cellpadding="0" cellspacing="0">
           ...
           <tr valign="top">
             <td align="left">Promo Code:</td>
             <td align="left"><input required type="text" size="25" maxlength="100" name="code" value="" class="forms10" /></td>
           </tr>
           <tr valign="top">
             <td height="5"></td>
           </tr>
