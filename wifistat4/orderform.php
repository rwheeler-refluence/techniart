...
switch($action){
	case "add":
		...
		$sqlc="select * from tblorderstosend4 where sess='$sess' && status='open'";
		$resultc=db_query($sqlc);
		$countc=mysql_num_rows($resultc);
		if(!$countc){
			$sql="insert into tblorderstosend4 values ('','$sess','','','$stamp','open')";
			$result=db_query($sql);
		...
		$_SESSION['otsID']=$next;
		#add item to cart
		$sqli="select * from tblotsdetail4 where itemNo='$itemNo' && otsID='$next'";
		#print("".$sqli."<br />");
		$resulti=db_query($sqli);
		$counti=mysql_num_rows($resulti);
		if(!$counti){
			$sql2="insert into tblotsdetail4 values ('','$next','$itemNo','$quantity','$price','$desc')";
		}else{
			...
			$sql2="update tblotsdetail4 set qty='$newqty' where otsdetailID='$otsdetailID'";
		}
#		print($sql2);
	...
	case "update":
		...
		for($i=0;$i<count($otsdetailID);$i++){
			$sql="update tblotsdetail4 set qty='$qty[$i]' where otsdetailID='$otsdetailID[$i]'";
#print("".$sql."<br />");			
			$result=db_query($sql);
		}
	break;
...
document.form1.sfname.value=document.form1.ship_fname.value;
document.form1.slname.value=document.form1.ship_lname.value;
document.form1.saddress1.value=document.form1.ship_address1.value;
document.form1.saddress2.value=document.form1.ship_address2.value;
document.form1.scity.value=document.form1.ship_city.value;
document.form1.sstate.value=document.form1.ship_state.value;
document.form1.szip.value=document.form1.ship_zip.value;
}
...
<link rel="stylesheet" type="text/css" href="https://www.techniart.us/wifistat1/js/shadowbox.css">
<script type="text/javascript" src="https://www.techniart.us/wifistat1/js/shadowbox.js"></script>
...
$sql="select * from tblotsdetail4 where otsID='$o'";
$result=db_query($sql);
...
Orders will only be shipped to National Grid's gas residential customers residing in Upstate New York only.<br>
  <br>
</div>
    ...
    <td align="left"><input required type="text" name="ship_city" id="ship_city" class="forms10" />
        ...
        <span class="accordion-section-title">Billing Information</span>
        ...
        <br>
         <span class="accordion-section-title">Service Address</span>
<table width="100%" align="left" border="0" cellspacing="0" cellpadding="0">
          <tr align="top">
          <td colspan="2" align="left"><span class="footer_content_style1">Please fill in this information to help verify your order faster.</span></td></tr><br>

          <tr valign="top">
          <tr valign="top">
            <td colspan="2" align="left"><span class="cart">
              <input type="radio" name="same" value="yes" onClick="pop1();">
              Same as Shipping Info:&nbsp;&nbsp;<span class="cart">
              <input type="radio" name="same" value="yes" onClick="pop2();">
              Same as Billing Info:<br /><br />
              </td>
          </tr>
          <tr valign="top">
            <td width="40%" align="left"><span class="cart">First Name: </td>
            <td width="60%" align="left"><input  type="text" size="25" maxlength="100" name="sfname" value="" class="forms10" /></td>
          </tr>
          <tr valign="top">
            <td height="5"></td>
          </tr>
          <tr valign="top">
            <td align="left"><span class="cart">Last Name: </td>
            <td align="left"><input  type="text" size="25" maxlength="100" name="slname" value="" class="forms10" /></td>
          </tr>
          <tr valign="top">
            <td height="5"></td>
          </tr>
          <tr valign="top">
            <td align="left"><span class="cart">Address Line 1: </td>
            <td align="left"><input  type="text" size="25" maxlength="100" name="saddress1" value="" class="forms10" /></td>
          </tr>
        <tr valign="top">
            <td height="5"></td>
          </tr>
          <tr valign="top">
            <td align="left"><span class="cart">Address Line 2:</td>
            <td align="left"><input type="text" size="25" maxlength="100" name="saddress2" class="forms10" /></td>
          </tr>
          <tr valign="top">
            <td height="5"></td>
          </tr>
          <tr valign="top">
            <td align="left"><span class="cart">City: </td>
            <td align="left"><input  type="text" size="25" maxlength="40" name="scity" value="" class="forms10" /></td>
          </tr>
          <tr valign="top">
            <td height="5"></td>
          </tr>
          <tr valign="top">
            <td align="left"><span class="cart">State: </td>
            <td align="left"><select  name="sstate" class="forms10">
          ...
          <tr valign="top">
            <td align="left"><span class="cart">ZIP Code (5 digit): </td>
            <td align="left"><span class="cart">
              <input  type="text" size="5" maxlength="5" name="szip" value="" class="forms10" />
              </td>
          </tr>
          <tr valign="top">
            <td height="5"></td>
