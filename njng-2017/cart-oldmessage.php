...
if($limit > '12'){
	...
	print("<div align=\"center\" class=\"style5\"<br><br><br><br><br>Your order is over the <b>12 bulb limit!</b><br><br><br><a href=\"http://www.techniart.com/ces/store-cat.php?cat=LED%20Products\">Click here to start over</a><br><br><br><br><br><br><br>");
}else{
print("<div>");
if(!$count){
...
#		print("".$calcweight."<br>");
		...
		print("<td><a class=\"product_title1\" href=\"#\" onClick=\"javascript: decision('Are you sure you want to remove this item from your shopping bag?', 'http://www.techniart.com/ces/remove.php?ID=".$otsdetailID."');\"><span class=\"product_title\">REMOVE?</span></a></td>\n");
	...
	print("<td width=\"550\"><span class=\"style5\">To qualify for <strong>$7</strong> flat rate shipping you must spend <strong>$".number_format($ship_difference, 2, '.', ',')."</strong> more.</span></td>\n");}
			if ($carttot >= '25'){
	print("<td width=\"550\"><span class=\"style5\">You have qualified for $7 flat rate shipping.</span></td>\n");}
...
#	print("</tr>\n");
	...
	print("</tr></form>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><a class=\"product_title2\" href=\"http://www.techniart.com/ces/empty.php?otsID=".$o."\">Empty Cart</a></td>\n");
	print("</tr>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><a class=\"product_title2\" href=\"http://www.techniart.com/ces/store-cat.php?cat=LED%20Products\">Continue Shopping</a></td>\n");
	print("</tr>\n");
	print("<tr>\n");
	...
	print("&nbsp;&nbsp;<div class=\"style5\">You have purchased <b>".$limit."</b> of the <b>12</b> products allowed per order.");
