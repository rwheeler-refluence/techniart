...
if ($bulblimit>36){echo "<SCRIPT LANGUAGE='JavaScript'>
        window.alert('You have exceeded the limit of bulbs allowed.')
		window.location.href='https://www.techniart.us/johanna/cart.php'
        </SCRIPT>";}
if ($APSlimit>3){echo "<SCRIPT LANGUAGE='JavaScript'>
...
<div class="accordion">
  ...
  <option value="NJR Home Services">NJR Home Services</option>
  <option value="Rockaway">Rockaway</option>
  <option value="Wall General Office">Wall General Office</option>
            </select></td>
          </tr>
          <tr valign="top">
            <td colspan="2" align="left"><img src="pix/pix_trans.gif" width="1" height="5"></td>
