...
<td width="906" class="title_bkg"><div align="left" class="cp_title" id="title_spacer">ZIP CODE NOT QUALIFIED</div></td>
</tr></table>
<table width="906" border="0" align="center" cellpadding="0" cellspacing="0" class="bkg_body-main" height="250">
    <tr valign="top">
      ...
      <table width="904" border="0" align="center">
        <tr><br>
          <td width="848" height="51"><div align="center"><span class="product_price"><br><br>
            Sorry, this promotion is only available to residential customers of Amigo Energy<br>
            in the CenterPoint Energy Houston Electric service area. <br><br>
If you have any questions regarding your eligibility, please send an email to: <a href="mailto:customerservice@techniart.com">customerservice@techniart.com</a>.</span><br>
          </div></td>
        </tr>
        </table></td>
    <td width="1" bgcolor="d9d3a4"></td></tr>
  </table>
