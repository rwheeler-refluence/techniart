...
ORDERS WILL ONLY BE SHIPPED TO RESIDENTIAL ELECTRIC CUSTOMERS OF AMEREN MISSOURI.<br>
  <br>
</div>
    ...
    <td align="left"><input required type="text" name="ship_city" id="ship_city" class="forms10" />
         ...
         <tr valign="top">
          ...
          <tr valign="top">
           <td align="left"><span class="cart">Account Number: *<br>(10-digits, ex: 1234567890)</td>
  <td align="left"><input pattern=".{10,}" required name="account" id="account" type="text" size="10" maxlength="10" value="" class="forms10"></td>
          </tr>
