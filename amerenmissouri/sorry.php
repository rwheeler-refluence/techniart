    ...
    <table width="100%" border="0">
        <tr>
          <td align="left"><span class="cart"><br>
            ...
            <p class="cart">Sorry, this Room Air Cleaner Sale is only available to Ameren Missouri residential electric customers. 
            <br>
<br>
  Room Air Cleaners from this sale will only be shipped to qualifying ZIP codes within Missouri.<br>
              <br>
If you have any questions regarding your eligibility, please send an email to: <a href="mailto: customerservice@techniart.com">customerservice@techniart.com</a></p>
            <p class="cart">Please include your name and address to help us verify your eligibility with Ameren.</p>
</td>
        </tr>
