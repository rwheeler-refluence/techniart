...
while($row=mysql_fetch_array($resulto)){
	...
	echo "<SCRIPT LANGUAGE='JavaScript'>
        window.alert('You may only purchase 3 Room Air Cleaners per residential address!')
		window.location.href='empty.php?otsID=".$o."'
        </SCRIPT>
        ";
}	
print("<div>");
...
#	print("</tr>\n");
	...
	print("<tr>\n");
	if($limit > '3'){
	print("<td colspan=\"5\" align=\"right\" class=\"style5\">In order to checkout,<br>please adjust your cart<br>to <b>3 total units or less</b>.</td>\n");	
	print("</tr>\n");
	print("<tr>\n");
	print("</table>\n");
	}else{
