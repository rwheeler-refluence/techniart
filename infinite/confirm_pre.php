...
if($countzip<1){echo "<SCRIPT LANGUAGE='JavaScript'>
		...
		window.location.href='https://www.techniart.com/infinite/orderform.php'
        </SCRIPT>";}
?>
...
<?
$o=$_SESSION['otsID'];
$sql="select * from tblotsdetail_infinite where otsID='$o'";
$result=db_query($sql);
		...
		if(!$_SESSION['zip']){
			...
			if($countz>0){
				while($rowz=mysql_fetch_array($resultz)){
					...
					$sqlu="update tblotsdetail_infinite set price='$disct_price' where otsdetailID='$otsdetailID'";
					#print($sqlu);
