...
if(!$count){
	...
	while($row=mysql_fetch_array($result)){
		...
		print("<td><a class=\"body_content_style1\" href=\"#\" onClick=\"javascript: decision('Are you sure you want to remove this item from your shopping bag?', 'https://www.techniart.com/nstar/remove.php?ID=".$otsdetailID."');\"><span class=\"body_content_style1\">REMOVE?</span></a></td>\n");
...
?>
<div align="left"><span class="body_content_style1">*Please note: Please fill out all fields. Sales tax and shipping (where applicable) will be calculated on the confirmation page.</span></div><br>
...
<td width="429" align="left"><table width="313" border="0" cellpadding="0" cellspacing="0">
  <tr valign="top">
