...
<td width="906" class="title_bkg"><div align="left" class="cp_title" id="title_spacer">PRODUCT CATEGORIES</div></td>
</tr></table>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$modelNumber=$rowp['modelNumber'];
			$loc=$rootDir."philips/pix/products/thumbnails/".$imageLoc;
			if(!file_exists($loc)){
				$loc=$rootDir."philips/pix/products/".$imageLoc;
				$folder="philips/pix/products/";
			}else{
...
?>
<td width="275">
<form method="post" action="https://www.techniart.com/philips/cart-snopud.php">
<input type="hidden" name="action" value="add">
<table width="275" border="0" cellspacing="0" cellpadding="0"><tr valign="top">
<td width="106"><a href="store-detail-snopud.php?ID=<? echo($productID);?>&show=<? echo($show);?>"><img src="<? echo($folder);?><? echo($imageLoc);?>" alt="<? echo($productName);?>" width="<? echo($width);?>" height="<? echo($height);?>" border="0" class="img_stroke"></a></td>
...
<?}?>
<a href="store-detail-snopud.php?ID=<? echo($productID);?>&show=<? echo($show);?>"><img src="pix/b_more-info_sm.gif" alt="Learn more" width="55" height="19" border="0"></a></td>
</tr></form><br></table>
