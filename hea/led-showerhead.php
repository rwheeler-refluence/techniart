...
<html>
<head>
<title>TechniArt - NSTAR LED &amp; Showerhead</title>
...
<div align="center">
  ...
  <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td height="379" valign="bottom" background="led-sh-back.jpg"><div align="right">
          <?
...
?>
  ...
  <table width="900" border="1" align="center">
    ...
    <tr>
      <td height="52" colspan="2"><div align="center"><span class="style1">The LED 4-Pack &amp; Showerhead kit contains the following products:</span></div></td>
    </tr>
    <tr>
      <td width="334" height="260"><div align="center"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"></div></td>
      <td width="550" align="left"><div class="style1">4 - 60 watt equivalent Omni-directional LED A19s </div>
          <ul>
            <li>
    ...
    <tr>
      ...
      <td align="left"><div class="style1">1 - Evolve Roadrunner II Showerhead<br>
        ...
        <ul>
          ...
          <li>
            1.5 gpm (5.7 L/min) maximum flow @ 80 psi
          </li>
          <li>
			1.1 gpm (4.2 L/min) minimum flow @ 45 psi
          </li>
