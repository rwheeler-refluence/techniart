...
<form method="get" action="search-discount.php"><input type="hidden" name="action" value="search"><span class="section_heading_style1"><img src="pix/g_arrow.gif" alt="" width="28" height="22" border="0">Search our store</span>&nbsp;<span class="body_content_style2">(<a class="body_content_style2" href="search-discount.php">Advanced Search</a>)</span><br>
<img src="pix/pix_trans.gif" alt="" width="1" height="5" border="0"><br>
...
<table width="331" border="0" cellspacing="0" cellpadding="0"><tr valign="top"><form method="post" action="changezip.php" target="_new"><input type="hidden" name="redir" value="<? echo($page);?>">
...
<form method="get" action="search-discount.php"><span class="section_heading_style1"><img src="pix/g_arrow.gif" alt="" width="28" height="22" border="0">Search our store</span>&nbsp;<span class="body_content_style2">(<a class="body_content_style2" href="search-discount.php">Advanced Search</a>)</span><br>
<img src="pix/pix_trans.gif" alt="" width="1" height="5" border="0"><br>
