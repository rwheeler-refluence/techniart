...
<html>
<head>
<title>TechniArt - SnoPUD Limited Time Offer</title>
...
<div align="center">
<!-- ------------------------------begin header------------------------------ -->
<? include("header-snopud.php"); ?>
<!-- ------------------------------end header------------------------------ -->

<!-- ------------------------------begin body------------------------------ -->
<table width="906" border="0" cellspacing="0" cellpadding="0" align="center"><tr valign="top">
<td width="906" class="title_bkg"><div id="title_spacer" align="left"><span class="title_main">SnoPUD Limited Time Offer</span></div></td>
</tr></table>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."philips/pix/products/".$imageLoc;
			if(!file_exists($loc)){
...
<table width="255" border="2" bordercolor="#000000">
  <tr>
    <td width="275"><table width="255" border="0" cellpadding="0" cellspacing="1" bordercolor="0000000">
      <tr>
        <td colspan="2" valign="baseline" bordercolor="000000"><span class="product_title_lg">Lighting Facts </span><span class="section_heading_style1">Per Bulb</span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" bordercolor="000000" class="body_content_style2 style1"><span class="style3">Estimated Yearly 
          Energy Cost </span><span class="product_title">$
<?php 
		  $first_number=1095;
