...
<html>
<head>
<title>TechniArt -- National Grid Power Savings Pack Orders</title>
...
<td><span class="title_main_sub">National Grid Power Savings Pack Orders:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
if(!$page || $page==1){
	...
	print("<br>");
	$sql="select * from tblOrdersCompleted_dealsinri16 order by completeID desc";
	$result=db_query($sql);
...
#			print("</td>\n");
			print("<td><a class=\"body_content\" href=\"order_detail1.php?ID=".$completeID."\">DETAILS</span></td>\n");
            print("<td><a class=\"body_content\" href=\"order_email1.php?ID=".$completeID."\" target=\"_blank\">REGENERATE ORDER EMAIL</span></td>\n");
			print("</tr>\n");
			$text1="";
		}
		print("</table>\n");
