...
<script type="text/javascript" src="ddimgtooltip.js"></script></head>

<BODY><?php include("bluebar.php") ?><?php include("analyticstracking.php") ?><br>


<center><div align="center" class="fbwhitebox">
...
<td width="760"><div align="center" class="footer_content_style1"><div id="main_content_ip" align="left">
...
if(!$count){
	...
	while($row=mysql_fetch_array($result)){
		...
		print("<td align=\"center\"><input type=\"button\" value=\"Go Back\" onclick=\"location.href='cart.php'\"></td>\n");
...
<td width="415" height="293" align="left">
...
<td><span class="body_content_style1">Address Line 1:</span></td>
<td><input type="text" size="25" maxlength="100" name="ship_address1" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Address Line 2:<br>
    (optional)</span></td>
...
<td colspan="2"><span class="section_heading_style1">Billing Address:</span></td>
  ...
  <tr valign="top">
    <td colspan="2"><span class="body_content_style1">
      <input type="checkbox" name="same" value="yes" onClick="pop();">
      Same as Shipping Info:<br />
    </span></td>
  </tr>
  <tr valign="top">
    <td><span class="body_content_style1">First Name:</span></td>
    <td><input type="text" size="25" maxlength="100" name="fname" value="" class="forms3" /></td>
  </tr>
  <tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td width="120"><span class="body_content_style1">Last Name:</span></td>
<td width="185"><input type="text" size="25" maxlength="100" name="lname" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Address Line 1:</span></td>
...
<td><span class="body_content_style1">ZIP Code:</span></td>
<td><span class="body_content_style1"><input type="text" size="10" maxlength="10" name="zip" value="" class="forms2" />
(5 digit)</span></td>
</tr></table></td>
</tr>
  <tr valign="top">
    <td class="body_content_style1" colspan="3" align="left"><table width="592" border="0" align="left">
      <tr>
        <td width="471" colspan="3" class="body_content_style1"><div align="center"><span class="body_content_ip">          <br>
          ORDERS WILL ONLY BE SHIPPED TO PUGET SOUND ENERGY CUSTOMERS.<br>
          <br>
          </span></div></td>
      </tr>
...
<input type="submit" value="Review Order"></td>
</tr></table></td>
</tr></table>
</form>
</td>
...
<script language="Javascript">
 <!--
 alert ("The shipping zip code you entered does not match a zip code on our qualified list. Please enter a qualified shipping ZIP code.")
 //-->
 </script>
