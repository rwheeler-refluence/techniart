...
<html>
<head>
<title>TechniArt -- State Farm Online Orders</title>
...
<td><span class="title_main_sub">State Farm Online Orders:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
if(!$page || $page==1){
	...
	print("<br>");
	$sql="select * from tblOrdersCompleted_statefarm order by completeID desc";
	$result=db_query($sql);
