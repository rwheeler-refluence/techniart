...
<table background="back-top.jpg" width="760" height="15"border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td></td>
  </tr>
</table>
<table width="760" class="bkg_body-main">
<tr>
<td>  
<?
$o=$_SESSION['otsID'];
$sql="select * from tblotsdetail_facebook LEFT OUTER JOIN tblProducts_facebook on tblotsdetail_facebook.itemNo=tblProducts_facebook.productID where tblotsdetail_facebook.otsID='$o'";
#print($sql);
$result=db_query($sql);
 ...
 while($row=mysql_fetch_array($result)){
	...
	/*	if(strlen($_SESSION['zip_qualify'])>0){
		...
		if(strlen($_SESSION['zip_qualify'])>0){
			...
			if($pr!==$price){
				$sqlu="update tblotsdetail_facebook set price='$pr' where otsdetailID='$otsdetailID'";
		#		$resultu=db_query($sqlu);
			}
...
#	print("</tr>\n");
	...
	print("</tr>\n");
	print("<tr>\n");
	print("<td colspan=\"3\" align=\"right\"><form method=\"post\" action=\"https://secure40.securewebsession.com/techniart.com/facebook/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"hidden\" name=\"ship\" value=\"".$ship."\"><input type=\"hidden\" name=\"state\" value=\"".$_SESSION["shipping"]["state"]."\"><input type=\"submit\" value=\"Checkout\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
	print("</tr></form>\n");
	print("</table></form>\n");
}	?>
<tr><td>
