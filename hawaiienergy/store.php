...
<html>
<head>
<title>TechniArt - Online Sale</title>
...
<div align="right"><span class="title_main">$10 Flat rate shipping on orders!</span></div>
<?
$subcat=$_GET['subcat'];
...
$i=1;
	...
	if(!$subcat){
		...
		print("&nbsp;&nbsp;|&nbsp;&nbsp;<a class=\"product_title1\" a href=\"http://www.techniart.us/hawaiienergy-promo/\">Promotions</a>");
		if($countsubs>0){
			print("<br>");
		}
	}else{
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$modelNumber=$rowp['modelNumber'];
			$loc=$rootDir."hawaiienergy/pix/products/thumbnails/".$imageLoc;
