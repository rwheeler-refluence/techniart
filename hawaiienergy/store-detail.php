...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."hawaiienergy/pix/products/".$imageLoc;
...
<span class="product_price">$<? echo(number_format($price, 2, '.', ','));?></span><br>
<br>
...
<? if($class=='light'){?><table width="255" border="2" bordercolor="#000000" bgcolor="ffffff">
  <tr>
...
<span class="body_content_style1">
<? if($descrip){?>
<b>Description:</b> <? echo($descrip);?><br><br>
<?}?><br>
