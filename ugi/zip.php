...
<span class="section_heading_style1">Look for discounted prices provided by</span><br>
    <span class="product_title_lg">UGI Utilities</span>.<br />
    <br />
  </td>
  <td width="372" rowspan="2" valign="middle"><div id="style3">
    <div align="center"><span class="style3"><strong>Get FREE shipping</strong><br />
      on all orders!</span><br /><br /><span class="product_price">Limit of 25 bulbs per purchase.<br />
        </span></div>
  </div></td>
</tr>
  <tr valign="top">
...
<td width="453" valign="middle"><div align="center"><span class="style3"><strong>Get FREE shipping</strong><br />
...
<? if($countzip<1){echo "<SCRIPT LANGUAGE='JavaScript'>
		...
		window.location.href='http://www.techniart.us/ugi/index.php'
        </SCRIPT>";}}?>