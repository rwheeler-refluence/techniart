	...
	<!--
		function fVerifyResForm() {
			...
			if (oForm.bill_zip.value.length == 0) {
				...
				if (oForm.bulbs.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the amount of CFLs/LEDs in your home.\n";
			}
			if (oForm.why.value=='') {
				errFlag = 1;
				errStr = errStr + "Please select your reason for purchasing.\n";
			}
...
&nbsp;&nbsp;Order Form </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style4"><strong>Get FREE shipping</strong> on all orders!</span></div></td>
</tr></table>
...
?>
<div align="left"><span class="body_content_style1">Please note: Sales tax will not be charged when shipping to Pennsylvania<br>
...
<tr valign="top">
  <td height="14" colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr>
</table>
...
<tr valign="top">
           <td align="left" class="body_content_style1">How many CFL's and LED's do you have installed in your home?:</td>
  <td align="left"><input name="bulbs" id="bulbs" type="number" size="25" value="" class="forms2"></td>
          </tr>
          <tr valign="top">
            <td height="5"></td>
          </tr>
          <tr valign="top">
            <td height="39" align="left"><span class="body_content_style1">Why are you purchasing today?</span></td>
            <td valign="middle" align="left"><select name="why" class="forms3">
             <option></option>
             <option value="Immediate replacement of an energy efficient bulb">Immediate replacement of an energy efficient bulb</option>
                          <option value="Immediate replacement of an incandescent or halogen bulb that has burned out">Immediate replacement of an incandescent or halogen bulb that has burned out</option>
                                       <option value="Immediate replacement of an incandescent or halogen bulb to reduce electricity usage">Immediate replacement of an incandescent or halogen bulb to reduce electricity usage</option>
                                                    <option value="Back-up for future needs">Back-up for future needs</option>
          ...
          <tr valign="top">
            ...
            <tr valign="top"><td height="39" align="left"><span class="body_content_style1">May we use your email for future email campaigns?</span></td>
...
<tr valign="top">
  <td class="body_content_style1" colspan="3" align="left">&nbsp;</td>
</tr>
</table>
</form>
</td>
