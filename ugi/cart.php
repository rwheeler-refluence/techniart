...
<td width="906"><div id="title_spacer" align="left"><span class="title_main">Shopping Cart</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style4"><strong>Get FREE shipping</strong> on all orders!</span></div> 
</td>
</tr></table>
...
#	print("<td width=\"550\"><span class=\"style5\">To qualify for <strong>FREE</strong> shipping you must spend <strong>$".number_format($ship_difference, 2, '.', ',')."</strong> more.</span></td>\n");}else
	#if ($carttot <25){
	#print("<td width=\"550\"><span class=\"style4\">To qualify for <strong>FREE</strong> shipping you must spend <strong>$".number_format($ship_difference, 2, '.', ',')."</strong> more.</span></td>\n");}
	#if ($carttot>=25 && $_SESSION['coupon']){
...
#	print("</tr>\n");
	...
	print("<tr><td colspan=\"4\" height=\"5\" align=\"right\"></td></tr>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><input type=\"button\" class=\"btn2\" value=\"Continue Shopping\" onclick=\"location.href='http://www.techniart.us/ugi/store.php'\"></td>\n");
	print("</tr>\n");
	print("<tr><td colspan=\"4\" height=\"5\" align=\"right\"></td></tr>\n");
print("<tr>\n");
...
if (mysql_num_rows($product25)) {
    ...
    $PQ25=$P25['qty']*4;}
$limit=$PQ1+$PQ2+$PQ3+$PQ4+$PQ5+$PQ6+$PQ7+$PQ8+$PQ9+$PQ10+$PQ11+$PQ12+$PQ13+$PQ14+$PQ15+$PQ16+$PQ17+$PQ18+$PQ19+$PQ20+$PQ21+$PQ22+$PQ23+$PQ24+$PQ25;
	if($limit > '25'){
	print("<td colspan=\"4\" align=\"right\" class=\"style5\">In order to checkout,<br>please adjust your cart<br>to <b>25 total products</b>.</td>\n");	
	print("</tr>\n");
	print("<tr>\n");
	print("</table>\n");
	}else{
...
$zero=0;
	...
	print("&nbsp;&nbsp;<div class=\"style5\">Your cart contains <b>".$limit."</b> of the <b>25</b> products allowed per order.");
