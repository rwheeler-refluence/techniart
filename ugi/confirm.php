...
<td width="906"><div id="title_spacer" align="left"><span class="title_main">Confirmation</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style4"><strong>Get FREE shipping</strong> on all orders over $25!</span></div></td>
</tr></table>
...
<table><tr valign="top">
<td colspan="2"><span class="product_price">Shipping Address:</span></td>
</tr><tr valign="top">
<td><span class="body_content_style1"><? echo($ship_fname); ?> <? echo($ship_lname); ?><br><? echo($ship_address1); ?> <? echo($ship_address2); ?><br>
<? echo($city); ?>, <? echo($ship_state); ?><br><? echo($ship_zip); ?><br></span></td>
</tr></table>
</span></td>
<td width="10">&nbsp;</span></td>
<td width="235" align="left">
<table><tr valign="top">
<td colspan="2"><span class="product_price">Billing Address:</span></td>
</tr><tr valign="top">
<td><span class="body_content_style1"><? echo($fname); ?> <? echo($lname); ?><br><? echo($address1); ?> <? echo($address2); ?><br>
<? echo($city); ?>, <? echo($state); ?><br><? echo($bill_zip); ?><br><br>

<b>Phone:</b> <? echo($phone); ?><br>
...
<span class="product_price">Payment Info:</span>
<table>
...
<td colspan="2" align="center"><img src="pix/pix_trans.gif" width="1" height="10"><br><div align="center"><input type="button" class="btn" value ="Place Order" onClick="this.form.submit();" /></div></span></td>
</tr></table>
</span></td></tr></table>
</form>
<?}?>
