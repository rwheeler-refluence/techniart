...
<td width="906" class="head-back"><div id="title_spacer" align="left"><span class="title_main"><b>UGI Utilities' online store</b></span></div></td>
</tr></table>
...
<div align="center"><img src="6-pack.jpg" alt="" width="760" height="450" usemap="#Map" border="0"/></div>
 <map name="Map">
  <area shape="rect" coords="43,351,345,412" onClick="myform.submit();">
	</map><br></form>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$imageLoc=$rowp['imageLoc'];
			$loc=$rootDir."ugi/pix/products/thumbnails/".$imageLoc;
