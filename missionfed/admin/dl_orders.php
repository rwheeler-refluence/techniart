...
<?
$sql="select * from tblOrdersCompleted_mission";
#print($sql);
$result=db_query($sql);
...
$combo="select qty as ComboQuantity from tblotsdetail_mission where otsID='$otsID' && itemNo='242' && qty>'0'";
...
$br="select qty as BRQuantity from tblotsdetail_mission where otsID='$otsID' && itemNo='243' && qty>'0'";
