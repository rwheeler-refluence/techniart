...
<html>
<head>
<title>TechniArt -- Mission Fed Orders</title>
...
<td><span class="title_main_sub">Mission Fed Orders:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
if(!$page || $page==1){
	...
	print("<br>");
	$sql="select * from tblOrdersCompleted_mission order by completeID desc";
	$result=db_query($sql);
