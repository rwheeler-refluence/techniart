...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?
$o=$_SESSION['otsID'];
$sql="select * from tblotsdetail_mission LEFT OUTER JOIN tblProducts on tblotsdetail_mission.itemNo=tblProducts.productID where tblotsdetail_mission.otsID='$o'";
$combo="select qty as ComboQuantity from tblotsdetail_mission where tblotsdetail_mission.itemNo='242' && tblotsdetail_mission.otsID='$o'";
$br="select qty as BRQuantity from tblotsdetail_mission where tblotsdetail_mission.itemNo='243' && tblotsdetail_mission.otsID='$o'";
$comboup="update tblotsdetail_mission set qty='5' where tblotsdetail_mission.itemNo='242' && tblotsdetail_mission.otsID='$o'";
$brup="update tblotsdetail_mission set qty='6' where tblotsdetail_mission.itemNo='243' && tblotsdetail_mission.otsID='$o'";
#print($sql);
#print($sql);
$result=db_query($sql);
...
if ($combolimit>5){
	...
	echo "<SCRIPT LANGUAGE='JavaScript'>
        window.alert('You may only purchase 5 of the LED 8-packs per household!')
...
print("<table align=\"center\" width=\"90%\" cellpadding=\"1\" cellspacing=\"1\">\n");
 ...
 while($row=mysql_fetch_array($result)){
	...
	/*	if(strlen($_SESSION['zip_qualify'])>0){
			$pr=$row['disct_price'];
			if($pr!==$price){
			$sqlu="update tblotsdetail_mission set price='$pr' where otsdetailID='$otsdetailID'";
...
#	print("</tr>\n");
	...
	print("<tr>\n");
	if($combolimit<1){
	print("<td colspan=\"3\" align=\"right\"><form method=\"post\" action=\"adda19.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Add A19 8-Pack\" class=\"btn1\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
	print("</tr></form>\n");}
		if($brlimit<1){
