...
<center><div align="center"><span class="body_content_ip"> <br>
  ORDERS WILL ONLY BE SHIPPED TO MASS SAVE CUSTOMERS.<br>
  <br>
</div>
       <div class="accordion">
    <div class="accordion-section">
        ...
        <div class="accordion">
    <div class="accordion-section">
        <a class="accordion-section-title" href="#accordion-2">Shipping Information - Click to slide open</a>
         <div id="accordion-2" class="accordion-section-content">
        
        <table width="100%"  align="left" border="0" cellpadding="0" cellspacing="0">
           <tr valign="top">
            <td align="left"><span class="cart">Office location:</td>
            <td align="left"><select name="ship_country" id="ship_country" value="<? echo($country); ?>" class="forms5">
    ...
    <option value="Metro">Metro</option>			
          ...
          <tr valign="top">
            <td align="left"><span class="cart">Mail stop#:</td>
            <td align="left"><input type="text" size="25" maxlength="100" name="mail" class="forms10" /></td>
          </tr>
