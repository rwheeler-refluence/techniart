...
function updateStk() {
  var updateurl = "includes/php/cc_update_custinfo_process.php?mform="; // The server-side script
  var mindex =0;
  var tdt=""; 
  var yrtst = 0;
  var yearstart="19";   
...
if (checkforErrors == 0) {
  ...
  // s[2] is a date and needs date conversion
  ...
  if (tdt.length > 6){
     ...
     s[2]= yearstart+tdt.charAt(6)+tdt.charAt(7)+tdt.charAt(0)+tdt.charAt(1)+tdt.charAt(3)+tdt.charAt(4);
  } else {s[2]= " "};

  // s[3] is a date and needs date conversion
  ...
  if (tdt.length > 6){
     ...
     yrtst=tdt.charAt(7)+tdt.charAt(8);
     if (yrtst < 80) {yearstart="20"}; 
     s[3]= yearstart+tdt.charAt(6)+tdt.charAt(7)+tdt.charAt(0)+tdt.charAt(1)+tdt.charAt(3)+tdt.charAt(4);
  } else {s[3]= " "};
  ...
  // s[8] is a date and needs date conversion
  ...
  if (tdt.length > 6){
     ...
     yrtst=tdt.charAt(7)+tdt.charAt(8);
     if (yrtst < 80) {yearstart="20"}; 
     s[8]= yearstart+tdt.charAt(6)+tdt.charAt(7)+tdt.charAt(0)+tdt.charAt(1)+tdt.charAt(3)+tdt.charAt(4);
  } else {s[8]= " "};
  ...
  // s[26] is a date and needs date conversion
  ...
  if (tdt.length > 6){
     ...
     yrtst=tdt.charAt(7)+tdt.charAt(8);
     if (yrtst < 80) {yearstart="20"}; 
     s[26]= yearstart+tdt.charAt(6)+tdt.charAt(7)+tdt.charAt(0)+tdt.charAt(1)+tdt.charAt(3)+tdt.charAt(4);
  } else {s[26]= " "};
