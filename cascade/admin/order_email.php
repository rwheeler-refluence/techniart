...
#						print($sqlz);
					...
					$totfin=$sumtot+$shipping;
									$body."\n\n\n";
									$body.="\nSubtotal: $".number_format($sumtot, 2, '.', ',')."\n";
									$body.="Ship: $".number_format($shipping, 2, '.', ',')."\n";
...
TechniArt\n";
					...
					#}
						...
						#mail($to=$email,$subject="Thank you for your Cascade Water order from techniart.com",$body,"From:".$from."");
					}
print("<pre>");
print($body);
print("</pre>");
