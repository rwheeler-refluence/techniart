...
<?
	...
	$sql="select * from tblOrdersCompleted order by stamp desc";
#	print($sql);
	$result=db_query($sql);
	$count=mysql_num_rows($result);
	if(!$count){
	}else{
		$out.="\"Date\",\"Ship First Name\",\"Ship Last Name\",\"Address\",\"Address 2\",\"City\",\"State\",\"Zip\",\"Instructions\",\"Email\",\"Account\",\"Kitchen Faucet Aerator\",\"Sprinkler System DVD\",\"Earth Massage Chrome Showerhead\",\"Earth Massage Showerhead\",\"Spray Clean Showerhead\",\"Dye Tablets/Strips\",\"Rain Gauge\",\"Shower Timer\",\"Bathroom Faucet Aerator\",\n";
...
{$ENLlimit=$row['ENLQuantity']*1;}}else{
$ENLlimit='0';}
...
{$DNLlimit=$row['DNLQuantity']*1;}}else{
$DNLlimit='0';}
...
{$Candlelimit=$row['CandleQuantity']*1;}}else{
$Candlelimit='0';}
...
{$Globelimit=$row['GlobeQuantity']*1;}}else{
$Globelimit='0';}
...
{$MR16limit=$row['MR16Quantity']*1;}}else{
$MR16limit='0';}
...
{$Threewaylimit=$row['ThreewayQuantity']*1;}}else{
$Threewaylimit='0';}
...
{$BR20limit=$row['BR20Quantity']*1;}}else{
$BR20limit='0';}
...
{$Par38limit=$row['Par38Quantity']*1;}}else{
$Par38limit='0';}		
...
{$Fourlimit=$row['FourQuantity']*1;}}else{
$Fourlimit='0';}	
...
{$Sixlimit=$row['SixQuantity']*1;}}else{
$Sixlimit='0';}	
			
		$out.="\"".$timestamp."\",\"".$ship_firstname."\",\"".$ship_lastname."\",\"".$ship_address."\",\"".$ship_address2."\",\"".$ship_city."\",\"".$ship_state."\",\"".$ship_zip."\",\"".$instructions."\",\"".$email."\",\"".$account."\",\"".$ENLlimit."\",\"".$DNLlimit."\",\"".$Candlelimit."\",\"".$Globelimit."\",\"".$MR16limit."\",\"".$Threewaylimit."\",\"".$BR20limit."\",\"".$Par38limit."\",\"".$Sixlimit."\",\n";
		}
...
header("Content-Disposition: attachment; filename=cascade-orders.csv");
echo $out;
exit;
