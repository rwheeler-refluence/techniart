...
<table width="906" border="0" cellspacing="0" cellpadding="0" align="center" class="bkg_body-main" height="400"><tr valign="top">
...
#	$date=date("m-d-Y H:m:s");
	$date=mktime();
	$sqlu="update tblCoupon set value='2' where code='$coupon'";
...
#fulfillment e-mail
$to="pesmerrga@techniart.com";
$from="sales@techniart.com";
$subject="FREE Reliant Order - techniart.com";
...
#						print($sqlz);
					...
					$totfin=$sumtot+$ship_price-$discount;
									...
									$body.="Total: $0.00\n";
									$body.="(Negative dollar amounts default to $0.00)\n";
									$body.="\n";
									#if($ship_state=='CT'){
