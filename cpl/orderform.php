...
$address2=$_SESSION['s_address2'];
$city=$_SESSION['s_city'];
$state=$_SESSION['s_state'];
$zip=$_SESSION['s_zip'];
$phone=$_SESSION['s_phone'];
$ship_fname=$_SESSION['s_ship_fname'];
$ship_lname=$_SESSION['s_ship_lname'];
$ship_address1=$_SESSION['s_ship_address1'];
$ship_address2=$_SESSION['s_ship_address2'];
$ship_city=$_SESSION['s_ship_city'];
$ship_state=$_SESSION['s_ship_state'];
$ship_zip=$_SESSION['s_ship_zip'];
if(!$ship){
...
switch($action){
	case "add":
		...
		$sqlc="select * from tblorderstosend_cpl where sess='$sess' && status='open'";
		...
		$_SESSION['otsID']=$next;
		#add item to cart
		$sqli="select * from tblotsdetail_cpl where itemNo='$itemNo' && otsID='$next'";
		#print("".$sqli."<br />");
		$resulti=db_query($sqli);
		$counti=mysql_num_rows($resulti);
		if(!$counti){
			$sql2="insert into tblotsdetail_cpl values ('','$next','$itemNo','$quantity','$price','$desc')";
		}else{
			...
			$sql2="update tblotsdetail_cpl set qty='$newqty' where otsdetailID='$otsdetailID'";
		}
#		print($sql2);
...
$sql="select * from tblotsdetail_cpl where otsID='$o'";
$result=db_query($sql);
...
#	}else{
	...
	$ship=number_format($shiprate, 2, '.', ',');
		print("<td align=\"left\"><span class=\"body_content_style1\">$".$ship."</span></td>\n");
	print("</tr>\n");}
	if ($carttot >=25 && $_SESSION['coupon'] && $vendor==30){
		print("<tr bgcolor=\"#FFFFFF\">\n");
	print("<td colspan=\"4\" align=\"right\"><span class=\"body_content_style1\"><b>Shipping:</b>&nbsp;</span></td>\n");
	$shiprate=0;
	$ship=number_format($shiprate, 2, '.', ',');
...
<div align="left"><span class="body_content_style1">*Please note: Sales tax will not be charged when shipping to Texas <br>
  If your order is under $25, you will be charged the standard UPS rate (~$13) on the next page.<br>
...
<td width="162"><input type="text" size="25" maxlength="100" name="ship_fname" value="<? echo($ship_fname);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Last Name:</span></td>
<td><input type="text" size="25" maxlength="100" name="ship_lname" value="<? echo($ship_lname);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Address 1:</span></td>
<td><input type="text" size="25" maxlength="100" name="ship_address1" value="<? echo($ship_address1);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
...
<td><input type="text" size="25" maxlength="40" name="ship_city" value="<? echo($ship_city);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
...
<td><span class="body_content_style1"><input type="text" size="10" maxlength="10" name="ship_zip" value="<? echo($ship_zip);?>" class="forms2" />
( 5 digit ZIP)</span></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
...
<tr valign="top">
  ...
  <td><input name="phone" id="phone" type="text" size="12" value="<? echo($phone);?>" class="forms3"></td>
</tr>
<tr valign="top">
  <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr>
<tr valign="top">
  ...
  <td><input name="email" id="email" type="text" size="25" value="<? echo($email);?>" class="forms3"></td>
</tr>
</table>
...
<td width="185"><input type="text" size="25" maxlength="100" name="fname" value="<? echo($fname);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Last Name:</span></td>
<td><input type="text" size="25" maxlength="100" name="lname" value="<? echo($lname);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Address 1:</span></td>
<td><input type="text" size="25" maxlength="100" name="address1" value="<? echo($address1);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Address 2:<br>(optional)</span></td>
<td><input type="text" size="25" maxlength="100" name="address2" value="<? echo($address2);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">City:</span></td>
<td><input type="text" size="25" maxlength="40" name="city" value="<? echo($city);?>" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">State:</span></td>
...
<td><span class="body_content_style1">ZIP Code:</span></td>
<td><span class="body_content_style1"><input type="text" size="10" maxlength="10" name="bill_zip" value="<? echo($zip);?>" class="forms2" />
(5 digit ZIP)</span></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
