...
<center><div align="center"><span class="body_content_ip"> <br>
  ORDERS WILL ONLY BE SHIPPED TO UGI RESIDENTIAL CUSTOMERS.<br>
  <br>
</div>
<div class="accordion">
    ...
    <td align="left"><input type="text" name="ship_city" id="ship_city" class="forms10" />
         ...
         <tr valign="top">
          ...
          <tr valign="top">
           <td align="left"><span class="cart">How many CFL’s and LED’s do you have installed in your home?: *</td>
  <td align="left"><input required name="bulbs" id="bulbs" type="number" size="25" value="" class="forms9"></td>
          </tr>
          <tr valign="top">
            <td height="5"></td>
          </tr>
          <tr valign="top"><td height="39" align="left"><span class="cart">Why are you purchasing today? *</span></td>
            <td valign="middle" align="left"><select name="why" class="forms10">
             <option></option>
          ...
          <tr valign="top">
            <td height="5"></td>
                    ...
                    <tr valign="top"><td height="39" align="left"><span class="cart">May we use your email for future email campaigns?</span></td>
