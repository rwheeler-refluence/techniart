...
<html>
<head>
<title>TechniArt -- Mass Save LTO Promo</title>
...
<td><span class="title_main_sub">Mass Save LTO:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
if(!$page || $page==1){
	...
	print("<br>");
	$sql="select *, AES_DECRYPT(bill_lastname, '$key') as bill_lastname from tblOrdersCompleted order by completeID desc";
	$result=db_query($sql);
