...
if($security!==md5($security_array[$chosen])){
	header("location: contact1.php?msg=security");
}else{
	...
	//	mail($To,$subject,$body,"From: $email");
		...
		$stamp=mktime();
		$sql="insert into tblAuditSignup values ('','$fname','$lname','$address','$address2','$city','$state','$zip','$email','$phone','$best_time','$interested','$dvd','$stamp')";
		$result=db_query($sql);
