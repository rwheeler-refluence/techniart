...
if($countzip<1){echo "<SCRIPT LANGUAGE='JavaScript'>
		...
		window.location.href='https://www.techniart.us/efficiencyconnection/orderform.php'
        </SCRIPT>";}
?>
		...
		if(!$_SESSION['zip']){
			...
			if($countz>0){
				while($rowz=mysql_fetch_array($resultz)){
					...
					$sqlu="update tblotsdetail_$rep set price='$disct_price' where otsdetailID='$otsdetailID'";
					#print($sqlu);
