...
#	$date=date("m-d-Y H:m:s");
	...
	$sql2="update tblorderstosend_free set status='Closed' where otsID='$otsID'";
	$result2=db_query($sql2);
	
#fulfillment e-mail
$to="tx-orders@techniart.com";
$from="sales@techniart.com";
$subject="FREE Champion ".$rep." Order - techniart.com";
...
#grab unnotified orders
	$sqla="select * from tblOrdersCompleted_free where completeID='$next'";
...
//			$body.="Sent on: ".date("m/d/Y H:i:s")."\n\n";
			...
			$sql="select * from tblotsdetail_free where otsID='$otsID' order by otsdetailID desc";
			#print($sql);
			$result=db_query($sql);
