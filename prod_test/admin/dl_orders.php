...
$out.="\"ID\",\"Date\",\"Ship First\",\"Ship Last\",\"Ship Address\",\"Ship Address 2\",\"Ship City\",\"Ship State\",\"Ship Zip\",\"Instructions\",\"Bill First\",\"Bill Last\",\"Bill Address\",\"Bill Address 2\",\"Bill City\",\"Bill State\",\"Bill Zip\",\"Email\",\"Question 1\",\"Question 2\",\"Account\",\"Heat Water\",\"Source\",\"Tax\",\"Total\",\"100w Kit\",\"A19 Filament Kit\",\"Candle Kit\"\n";
...
$out.="\"".$completeID."\",\"".$timestamp."\",\"".$ship_firstname."\",\"".$ship_lastname."\",\"".$ship_address."\",\"".$ship_address2."\",\"".$ship_city."\",\"".$ship_state."\",\"".$ship_zip."\",\"".$instructions."\",\"".$bill_firstname."\",\"".$bill_lastname."\",\"".$bill_address."\",\"".$bill_address2."\",\"".$bill_city."\",\"".$bill_state."\",\"".$bill_zip."\",\"".$email."\",\"".$question1."\",\"".$question2."\",\"".$account."\",\"".$water."\",\"".$source."\",\"".$tax."\",\"".$amount."\",\"".$combolimit."\",\"".$medlimit."\",\"".$canlimit."\"\n";
		}
