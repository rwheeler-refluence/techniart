...
//$bill_firstname = str_replace("'", "&#39;", $fname);
//$bill_lastname = str_replace("'", "&#39;", $lname);
//$bill_address1 = str_replace("'", "&#39;", $address1);
//$bill_city = str_replace("'", "&#39;", $city);
//$ship_firstname = str_replace("'", "&#39;", $ship_fname);
//$ship_lastname = str_replace("'", "&#39;", $ship_lname);
//$ship_address = str_replace("'", "&#39;", $ship_address1);
//$ship_city1 = str_replace("'", "&#39;", $ship_city);
//$question3 = str_replace("'", "&#39;", $question2);

$bill_firstname = mysql_real_escape_string($fname);
$bill_lastname = mysql_real_escape_string($lname);
$bill_address1 = mysql_real_escape_string($address1);
$bill_city = mysql_real_escape_string($city);
$ship_firstname = mysql_real_escape_string($ship_fname);
$ship_lastname = mysql_real_escape_string($ship_lname);
$ship_address = mysql_real_escape_string($ship_address1);
$ship_city1 = mysql_real_escape_string($ship_city);
$question3 = mysql_real_escape_string($question2);
?>
...
<input type=hidden name="ship_fname" value="<? echo($ship_firstname); ?>">
<input type=hidden name="ship_lname" value="<? echo($ship_lastname); ?>">
<input type=hidden name="ship_address1" value="<? echo($ship_address); ?>"> 
<input type=hidden name="ship_address2" value="<? echo($ship_address2); ?>">
<input type=hidden name="ship_city" value="<? echo($ship_city1); ?>">
...
<input type=hidden name="question2" value="<? echo($question3); ?>" />
<input type=hidden name="fname" value="<? echo($bill_firstname); ?>" />
<input type=hidden name="lname" value="<? echo($bill_lastname); ?>" />
<input type=hidden name="address1" value="<? echo($bill_address1); ?>" />
<input type=hidden name="address2" value="<? echo($address2); ?>" />
<input type=hidden name="city" value="<? echo($bill_city); ?>" />
...
<table width="100%">
  ...
  <tr valign="top">
    <td><span class="cart"><? echo($ship_firstname); ?> <? echo($ship_lastname); ?></span><br>
     <span class="cart"> <? echo($ship_address); ?>&nbsp;<? echo($ship_address2); ?></span><br>
      <span class="cart"><? echo($ship_city1); ?>, <? echo($ship_state); ?> <? echo($ship_zip); ?></span>
    </td>
  </tr>
</table><br>
...
<table width="100%">
  ...
  <tr valign="top">
    <td><span class="cart"><? echo($bill_firstname); ?> <? echo($bill_lastname); ?></span><br>
      <span class="cart"><? echo($bill_address1); ?>&nbsp;<? echo($address2); ?></span><br>
