...
#	print("</tr>\n");
	...
	print("<td colspan=\"5\" align=\"right\"><form method=\"post\" action=\"https://www.techniart.us/prod_test/orderform.php\"><input type=\"hidden\" name=\"source\" value=\"".$source."\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"hidden\" name=\"ship\" value=\"".$ship."\"><input type=\"hidden\" name=\"state\" value=\"".$_SESSION["shipping"]["state"]."\"><input type=\"submit\" class=\"btn1\" value=\"Checkout\"></td>\n");
	print("</tr></form>\n");
	print("<tr>\n");
	print("<td colspan=\"5\" align=\"right\"></td>\n");
	print("</tr>\n");
