...
#grab unnotified orders
	...
	if($counta){
		while($rowa=mysql_fetch_array($resulta)){
			...
			$access_company=$rowa['access_company'];
...
//			$body.="Sent on: ".date("m/d/Y H:i:s")."\n\n";
			$body.="".$access_company." placed an order on ".$stmp."\n\n";
			...
			$body.="Shiping note: ".$instructions."\n\n";
...
#						print($sqlz);
						...
						$body.="".$tot_qty." - ".$productDesc." (case qty-".$case_quantity.")\n";
