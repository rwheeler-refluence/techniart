...
<script language="javascript" type="text/javascript">
	<!--
		function fVerifyResForm() {
			...
			if (oForm.facility_name.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the facility name.\n";
			}

			if (oForm.facility_contact.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the name of the facility contact.\n";
			}

			if (oForm.facility_address1.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the installation address.\n";
			}

			if (oForm.facility_city.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the facility city.\n";
			}

			if (oForm.building.value=='') {
				errFlag = 1;
				errStr = errStr + "Please select the installation building type.\n";
			}

			if (oForm.facility_zip.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the facility ZIP code.\n";
			}
			if (oForm.facility_phone.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the facility phone number.\n";
			}
			if (oForm.facility_account.value.length == 0) {
				errFlag = 1;
				errStr = errStr + "Please enter the facility account number.\n";
			}
...
<td width="906"><div id="title_spacer" align="left"><span class="title_main">Order Form </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="product_title_lg"><strong>Get $7 flat rate shipping</strong> on all orders over $50!</span></div></td>
</tr></table>
...
?>
<div align="left"><span class="body_content_style1">*Please note: Sales tax will be assessed on the confirmation page<br>
    ALL FIELDS MUST BE FILLED OUT<br>
    <em class="body_content_events-private">ORDERS CONSISTING OF 300 OR MORE LAMPS WILL BE SUBJECT TO PRE-APPROVAL</em><br>
</span></div>
<br>
...
<td width="389" height="365" align="left">
...
<td width="151"><span class="body_content_style1">First Name:</span></td>
...
<td colspan="3"><span class="section_heading_style2">Billing Address:</span></td>
</tr><tr valign="top">
<td colspan="3"><span class="body_content_style1"><input type="checkbox" name="same" value="yes" onClick="pop();">Same as Shipping Info:<br /></span></td>
</tr><tr valign="top">
<td width="120"><span class="body_content_style1">First Name:</span></td>
<td width="262" colspan="2"><input type="text" size="25" maxlength="100" name="fname" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Last Name:</span></td>
<td colspan="2"><input type="text" size="25" maxlength="100" name="lname" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Address 1:</span></td>
<td colspan="2"><input type="text" size="25" maxlength="100" name="address1" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">Address 2:<br>(optional)</span></td>
<td colspan="2"><input type="text" size="25" maxlength="100" name="address2" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">City:</span></td>
<td colspan="2"><input type="text" size="25" maxlength="40" name="city" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td><span class="body_content_style1">State:</span></td>
<td colspan="2"><select name="state" class="forms2">
<option></option>
...
<td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
  ...
  <td><span class="body_content_style1">ZIP Code:</span></td>
  <td colspan="2"><span class="body_content_style1"><input type="text" size="10" maxlength="10" name="zip" value="" class="forms2" />
    (5 digit ZIP)</span></td>
</tr>
<tr valign="top">
  <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
...
<tr valign="top">
  ...
  <tr valign="top">
    <td align="left"><table width="352" border="0" cellpadding="0" cellspacing="0">
      <tr valign="top">
        <td colspan="3"><span class="section_heading_style2">Installation Information:</span></td>
      </tr>
      <tr valign="top">
        <td colspan="3">&nbsp;</td>
      </tr>
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Facility Name:</span></td>
        <td width="177"><input type="text" size="25" maxlength="100" name="facility_name" value="" class="forms3" /></td>
      </tr>
      <tr valign="top">
        <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
      </tr>
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Facility Contact Name:</span></td>
        <td><input type="text" size="25" maxlength="100" name="facility_contact" value="" class="forms3" /></td>
      </tr>
      <tr valign="top">
        <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
      </tr>
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Installation Address:</span></td>
        <td><input type="text" size="25" maxlength="100" name="facility_address1" value="" class="forms3" /></td>
      </tr>
      <tr valign="top">
        <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
      </tr>
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Installation Address 2:<br>
          (optional)</span></td>
        <td><input type="text" size="25" maxlength="100" name="facility_address2" class="forms3" /></td>
      </tr>
      <tr valign="top">
        <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
      </tr>
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Installation City:</span></td>
        <td><input type="text" size="25" maxlength="40" name="facility_city" value="" class="forms3" /></td>
      </tr>
      <tr valign="top">
        <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
      </tr>
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Building Type:</span></td>
        <td><select name="building" id="building" class="forms3">
          <option></option>
          ...
          <option value="Hotel/Motel Common Areas">Hotel/Motel Common Areas</option>
          <option value="Hotel/Motel Rooms">Hotel/Motel Rooms</option>
      ...
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Installation ZIP Code:</span></td>
        <td><span class="body_content_style1">
          <input type="text" size="10" maxlength="10" name="facility_zip" value="" class="forms2" />
          (5 digit ZIP)</span></td>
      </tr>
      <tr valign="top">
        <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
      ...
      <tr valign="top">
        <td colspan="2"><span class="body_content_style1">Facility Phone number:</span></td>
        <td><input name="facility_phone" id="facility_phone" type="text" size="12" value="" class="forms3"></td>
      </tr>
      <tr valign="top">
        <td colspan="3"><img src="pix/pix_trans.gif" width="1" height="5"></td>
      </tr>
      <tr valign="top">
        <td width="120"><span class="body_content_style1">Facility PSE Account #:</span></td>
        <td width="55" valign="middle">2000-</td>
        <td><input name="facility_account" id="facility_account" type="text" size="25" value="" class="forms3"></td>
      </tr>
    </table></td>
...
<tr valign="top">
  <td colspan="2"><span class="section_heading_style2">Payment Info:</span></td>
  </tr>
<tr valign="top">
  <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr>
...
<script language="Javascript">
 <!--
 alert ("The facility zip code you entered does not match a zip code on our qualified list. Please enter a qualified facility ZIP code.")
 //-->
 </script>