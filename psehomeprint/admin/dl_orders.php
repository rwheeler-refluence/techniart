...
#	print($sql);
	...
	if(!$count){
		...
		$out.="\"Date\",\"Company\",\"Name\",\"Address\",\"Address 2\",\"City\",\"State\",\"Zip\",\"Ship Date\",\"Tracking\",\"Received?\",\"A19\",\"Globe\",\"BR30\",\"Bath Aerator\",\"Kitchen Aerator\",\"Showerhead\",\"Handheld\",\n";
...
{$Candlelimit=$row['CandleQuantity']*24;}}else{
$Candlelimit='0';}
...
$BR20limit='0';}
			...
			$out.="\"".$timestamp."\",\"".$company."\",\"".$ship_firstname." ".$ship_lastname."\",\"".$ship_address."\",\"".$ship_address2."\",\"".$ship_city."\",\"".$ship_state."\",\"".$ship_zip."\",\"".$ship_date."\",\"".$tracking."\",\"".$status."\",\"".$ENLlimit."\",\"".$DNLlimit."\",\"".$Candlelimit."\",\"".$Globelimit."\",\"".$MR16limit."\",\"".$Threewaylimit."\",\"".$BR20limit."\",\n";
		}
...
header("Content-Disposition: attachment; filename=PSEHP-orders.csv");
echo $out;
exit;
