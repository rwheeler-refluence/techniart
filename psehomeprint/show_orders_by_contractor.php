...
if($vendorName){
	print("<br>");
	$sql="select * from tblOrdersCompleted where tblOrdersCompleted.email_opt='$vendorName' order by tblOrdersCompleted.completeID desc";
#	print($sql);
	$result=db_query($sql);
	...
	if(!$count){
		...
		print("<div align=\"right\" style=\"padding-right:20px;\"><a class=\"body_content\" href=\"dl_orders_by_vendor.php?vendorName=".$vendorName."\">Download as *.csv</a></div>\n");
