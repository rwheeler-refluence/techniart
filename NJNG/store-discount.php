...
<td width="906" class="title_bkg"><div id="title_spacer" align="left"></div></td>
</tr></table>
...
<?
$sql="select distinct tblSort.category from tblSort LEFT OUTER JOIN tblProducts_raytheon on tblSort.category=tblProducts_raytheon.category order by tblSort.sort asc";
$result=db_query($sql);
$i=1;
?>
...
<?while($row=mysql_fetch_array($result)){
		...
		$sqlp="select * from tblProducts_raytheon where category='$category' && productPub='Yes' order by rand() limit 1";
#		print("<br>".$sqlp."<br>");
