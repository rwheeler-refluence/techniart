...
$ship=$_POST['ship'];
if(!$ship){
#	header("location: http://www.cunexttuesday.us/cart.php?msg=ship");
}
$action=$_POST['action'];
switch($action){
	case "add":
...
<!-- ------------------------------begin body------------------------------ -->
<table width="906" border="0" cellspacing="0" cellpadding="0" align="center" background="middle.jpg"><tr valign="top">
<td width="906"><div id="title_spacer" align="left"><span class="title_main">Order Form </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style4"><strong>Get $7 flat rate shipping</strong> on all orders!</span></div></td>
</tr></table>

<table width="906" border="0" cellspacing="0" cellpadding="0" align="center" class="bkg_body-main" background="middle.jpg"><tr valign="top">
