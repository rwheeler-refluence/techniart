...
function ups($dest_zip,$service,$weight,$length,$width,$height) {
	...
	$AccessLicenseNumber = 'DC4BAAE88B931D00'; // Your license number
	$UserId = '644CRUCI4051'; // Username
	$Password = 'km1208'; // Password
	$PostalCode = '06022'; // Zipcode you are shipping FROM
	$ShipperNumber = '879V8X'; // Your UPS shipper number
