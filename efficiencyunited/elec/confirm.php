...
<td width="218"><div id="title_spacer" align="left"><span class="title_main">Confirmation</span></div></td>
<td width="688" align="right"><span class="style4"><strong>Get free shipping</strong> on all orders for a limited time only!</span></td>
</tr>
</table>
...
#	print("weight: ".$weight."<br>");
	...
	print("<td style=\"padding-left:4px;\"><span class=\"body_content_style1\">FREE");
...
<table width="500" cellpadding="1" cellspacing="1"><tr valign="top">
...
<strong>City/State: </strong><? echo($city); ?>, <? echo($state); ?><strong><br>ZIP Code: </strong><? echo($zip); ?><br><br>How did you hear about this promo?&nbsp;<b><? echo($ship_country)?></b>
</span></td>
</tr></table>
</span></td>
</tr><tr valign="top">
...
<td colspan="2" align="center"><img src="pix/pix_trans.gif" width="1" height="10"><br><div align="center"><input type="button" value ="Place Order" onClick="this.form.submit();" / class="btn"></div><br>Please click the Place Order button only once to avoid duplicate charges</span></td>
</tr></table>
</span></td></tr></table>
</form>
<?}?>
