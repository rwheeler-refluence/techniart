...
$limit=$PQ1+$PQ2+$PQ3+$PQ4+$PQ5+$PQ6+$PQ7+$PQ8+$PQ9;
	print("<tr>\n");
	if($limit > '12'){
	print("<td colspan=\"4\" align=\"right\" class=\"style5\">In order to checkout,<br>please adjust your cart<br>to <b>12 total bulbs</b>.</td>\n");	
	print("</tr>\n");
	print("<tr>\n");
	print("</table>\n");
	}else{
	...
	print("&nbsp;&nbsp;<div class=\"style5\">Your cart contains <b>".$limit."</b> of the <b>12</b> bulbs allowed per order.");
