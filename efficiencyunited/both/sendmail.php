...
#if($refsplit[0]=='http://www.crucialnetworking.us/contact.php'){
...
if($security!==md5($security_array[$chosen])){
	...
	$headers .= "Reply-To: " . stripslashes(checkit($_POST['email'])) . "\r\n";
		...
		$To="customerservice@techniart.us";
		$subject="Submission from Efficiency United Web Store - techniart.us/efficiencyunited";
