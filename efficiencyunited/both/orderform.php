	...
	<!--
		function fVerifyResForm() {
			...
			if (oForm.ship_country.value=='') {
				errFlag = 1;
				errStr = errStr + "Please select how you learned of this promotion.\n";
			}
...
<td width="300" valign="middle"><div id="title_spacer" align="left"><span class="title_main">Order Form </span></td><td width="606" valign="middle" align="right"><span class="style4">Get <strong>free shipping</strong> on all orders for a limited time only!</span></td>
</tr></table>
...
?>
<div align="left"><span class="body_content_style1">*Please note: Sales tax will not be charged when shipping to Michigan<br>
</span></div>
<br>
<div align="left"><span class="body_content_style1">Orders will only be shipped to physical addresses. Orders shipped to PO Boxes will be cancelled.<br>
</span></div><br>
...
<table width="830" align="center" cellpadding="1" cellspacing="1"><tr valign="top">
      ...
      <tr valign="top">
        <td colspan="2"><span class="section_heading_style2">Shipping Address:</span></td>
          ...
          <td colspan="2">&nbsp;</td>
            ...
            <td width="181"><span class="body_content_style1">First Name:</span></td>
            <td width="185"><input type="text" size="25" maxlength="100" name="ship_fname" value="" class="forms3" /></td>
            </tr><tr valign="top">
                              ...
                              <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
                                ...
                                <td><select name="ship_state" class="forms2">
                                  ...
                                  <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
                                    ...
                                    <td><span class="body_content_style1"><input type="text" size="5" maxlength="5" name="ship_zip" value="" class="forms2" />
                                    ( 5 digit ZIP)</span></td>
                                    </tr><tr valign="top">
                                      <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
                                      </tr>
                            ...
                            <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
                              ...
                              <td><select name="state" class="forms2">
                                ...
                                <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
                                  ...
                                  <td><span class="body_content_style1">ZIP Code:</span></td>
                                  <td><span class="body_content_style1"><input type="text" size="5" maxlength="5" name="zip" value="" class="forms2" />
                                  (5 digit ZIP)</span></td>
                                  </tr><tr valign="top">
                                    <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
                                    </tr>
  ...
  <tr valign="top">
    <td height="39" align="left" valign="middle" class="body_content_style1"><div align="left">What is your primary heating type?</div></td>
    <td align="left" valign="middle" class="body_content_style1"><select name="bill_country" class="forms4">
      <option></option>
  ...
  <tr valign="top">
    <td width="332" height="39" align="left" valign="middle" class="body_content_style1"><div align="left">How did you learn about this promotion?</div></td>
    <td width="113" align="left" valign="middle" class="body_content_style1"><select name="ship_country" class="forms4">
      <option></option>
      <option value="Facebook">Facebook</option>
      <option value="Twitter">Twitter</option>
      <option value="Email">Email</option>
      <option value="Bill Stuffer">Bill Stuffer</option>
  ...
  <tr valign="top">
  <td class="body_content_style1" colspan="4" align="left">
