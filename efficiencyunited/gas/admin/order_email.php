...
We will notify you by email if any item in your order is on back order status. If you have a back order situation, you will be notified by email. Neither TechniArt nor Efficiency UNITED is responsible for misdirected or undeliverable packages.
...
TechniArt Inc.\n";
						...
						mail($to=$email,$subject="Thank you for your Efficiency UNITED order from techniart.com",$body,"From:".$from."");
					}
print("<pre>");
print($body);
print("</pre>");
