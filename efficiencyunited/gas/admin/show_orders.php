...
<html>
<head>
<title>TechniArt -- Efficiency UNITED Orders</title>
...
<td><span class="title_main_sub">Efficiency UNITED Orders:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
#			print("</td>\n");
			...
			$vendor=$row['name'];}
            print("<td><a class=\"body_content\">".$vendor."</span></td>\n");
			print("</tr>\n");
			$text1="";
		}
		print("</table>\n");
