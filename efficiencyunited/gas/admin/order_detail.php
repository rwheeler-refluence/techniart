...
if(!$page || $page==1){
	...
	if(!$count){
		...
		while($row=mysql_fetch_array($result)){
			...
			print("</tr>\n");
			$sqlv="select vendorName from tblVendors where vendorID=".$tax."";
			...
			print("<td><span class=\"body_content\">".$vendor."</span></td>\n");
			print("</tr>\n");
			print("<tr valign=\"top\">");
			print("<td bgcolor=\"#eaeef4\"><span class=\"body_content\"><b>Billing Address</b></span></td>\n");
			print("<td><span class=\"body_content\">".$billTo_street1." ".$billTo_street2."<br>".$billTo_city.",".$billTo_state." ".$billTo_postalCode."</span></td>\n");
			print("</tr>\n");
			print("<tr valign=\"top\">");
			print("<td bgcolor=\"#eaeef4\"><span class=\"body_content\"><b>Shipping Address</b></span></td>\n");
			print("<td><span class=\"body_content\">".$shipTo_street1." ".$shipTo_street2."<br>".$shipTo_city.",".$shipTo_state." ".$shipTo_postalCode."</span></td>\n");
			print("</tr>\n");
			print("<tr valign=\"top\">");
