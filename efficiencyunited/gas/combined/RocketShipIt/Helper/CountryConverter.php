...
class CountryConverter {
     ...
     * fullToTwoDigit
     *
     * @param string $fullCountryName
     * @return string two digit ISO country code
     */
    public function fullToTwoDigit($fullCountryName)
    {
        $fullCountryName = strtolower($fullCountryName);
        $countries = array_flip($this->countries);
        $countries = array_change_key_case($countries, CASE_LOWER);
        if (in_array($fullCountryName, array_keys($countries))) {
            return $countries[$fullCountryName];
        }
