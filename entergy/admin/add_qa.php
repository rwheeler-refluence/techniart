...
if($action=='add'){
	...
	$sql="insert into tblQA values ('','$questionTitle','$questionAns','No')";
	$result=db_query($sql);
...
<td><span class="title_main_sub">Q&A:</span>&nbsp;&nbsp;<span class="title_sub_level2">Add Q&A</span><br></td>
<td align="right">&nbsp;</td>
</tr><tr>
...
<br>
<img src="pix/pix_trans.gif" alt="" width="1" height="8" border="0"><br>
<input type="submit" name="Submit" value="Add Q&A"></form>
<br>
