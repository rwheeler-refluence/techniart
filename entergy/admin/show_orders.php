...
<html>
<head>
<title>TechniArt -- Entergy AR Orders</title>
...
<td><span class="title_main_sub">Amigo <? echo ($rep);?> Orders:</span>&nbsp;&nbsp;</td>
<td align="right">&nbsp;</td>
</tr><tr>
...
if(!$page || $page==1){
	...
	print("<br>");
	$sql="select * from tblOrdersCompleted where type='$rep' order by completeID desc";
	$result=db_query($sql);
