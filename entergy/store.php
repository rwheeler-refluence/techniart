...
<td width="906" class="head-back"><div id="title_spacer" align="left"><span class="title_main"><b>Entergy Arkansas' online store</b></span></div></td>
</tr></table>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$imageLoc=$rowp['imageLoc'];
			$loc=$rootDir."entergy/pix/products/thumbnails/".$imageLoc;
			#print $loc;
