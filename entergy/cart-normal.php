...
<td width="1" bgcolor="#d9d3a4"><img src="pix/pix_c8e1ea.gif" alt="" width="1" height="300" border="0"></td>
...
#		print("".$calcweight."<br>");
		...
		print("<td><a class=\"product_title1\" href=\"#\" onClick=\"javascript: decision('Are you sure you want to remove this item from your shopping bag?', 'http://www.techniart.com/reliant/remove.php?ID=".$otsdetailID."');\"><span class=\"product_title\">REMOVE?</span></a></td>\n");
...
#	print("</tr>\n");
	...
	print("</tr></form>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><input type=\"button\" value=\"Empty Cart\" onclick=\"location.href='http://www.techniart.com/reliant/empty.php?otsID=".$o."'\"></td>\n");
	print("</tr>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><input type=\"button\" value=\"Continue Shopping\" onclick=\"location.href='http://www.techniart.com/reliant/store-cat.php?cat=LED%20Products'\"></td>\n");
	print("</tr>\n");
	print("<tr>\n");
	if($limit > '24'){
	...
	print("<td colspan=\"4\" align=\"right\"><form method=\"post\" action=\"https://www.techniart.com/reliant/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"hidden\" name=\"ship\" value=\"".$ship."\"><input type=\"hidden\" name=\"state\" value=\"".$_SESSION["shipping"]["state"]."\"><input type=\"submit\" value=\"Checkout\"></td>\n");
	print("</tr></form>\n");
	print("</table>\n");
}
