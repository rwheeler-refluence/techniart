...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."entergy/pix/products/".$imageLoc;
			if(file_exists($loc)){
...
">
<td width="170"><a rel="shadowbox;" href="pix/products/<? echo($loc);?>" class="option" title="<? echo($productName);?>"><img src="<? echo($loc);?>" alt="<? echo($productName);?>" width="200" height="<? echo($height);?>" border="0" class="img_stroke"></a><br>
<? 
if($energy_star=='Yes'){
