...
<center><div align="center" class="fbwhitebox"><table background="back-top.jpg" width="760" height="15"border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    <td></td>
  </tr>
</table>
...
#	print("weight: ".$weight."<br>");
	...
	print("</tr>\n");
	if($state=='CT' || $state=='WA' || $state=='ME' || $state=='MA'){
...
<? echo($ship_city); ?>, <? echo($ship_state); ?><br><? echo($ship_zip); ?><br><br></span></td>
</tr></table>
</span></td>
<td width="10">&nbsp;</span></td>
<td width="235" align="left">
...
<td colspan="2" align="center"><img src="pix/pix_trans.gif" width="1" height="10"><br><div align="center"><input type="button" value ="Place Order" onClick="this.form.submit();" /></div><br><strong class="body_content_events-private">Please click the Place Order button once to avoid duplicate charges.</strong></span></td>
</tr></table>
</span></td></tr></table>
</form>
<?}?>
