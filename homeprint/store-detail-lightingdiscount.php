...
<html>
<head>
<title>TechniArt - Raytheon Online Lighting Fair</title>
...
<div align="center">
<!-- ------------------------------begin header------------------------------ -->
<? include("header-ssl.php"); ?>
<!-- ------------------------------end header------------------------------ -->

<!-- ------------------------------begin body------------------------------ -->
<table width="906" border="0" cellspacing="0" cellpadding="0" align="center"><tr valign="top">
<td width="906" class="title_bkg"><div id="title_spacer" align="left"><span class="title_main">Raytheon Online Lighting Fair</span></div></td>
</tr></table>
...
<form method="post" action="https://secure40.securewebsession.com/techniart.com/raytheon/cart.php">
