...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id=""><div class="blueBar" height:"50px"></div></td>
  </tr>
</table><br><table width="850" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
...
?>
            ...
            <form name="form1" id="form1" method="post" action="confirm_pre.php" onSubmit="return fVerifyResForm();">
              <input type="hidden" name="otsID" value="<? echo($o);?>">
              <input type=hidden name=paymentType value="<?=$paymentType?>" />
              <input type="hidden" name="ship" value="<?=$ship?>" />
              <table width="600" align="center" cellpadding="1" cellspacing="1">
                <tr valign="top">
                  <td width="415" align="left"><table width="276" border="0" cellpadding="0" cellspacing="0">
                      <tr valign="top">
                    ...
                    <tr valign="top">
                      ...
                      <td><span class="body_content_style1">
                        <input type="text" size="10" maxlength="10" name="ship_zip" value="" class="forms2" />
                  ...
                  <!-- <td width="10">&nbsp;</span></td> -->
                  <td width="415" align="left"><table border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                ...
                <tr valign="top">
                  <td class="body_content_style1" colspan="3" align="left"><img src="pix/pix_trans.gif" width="1" height="10"><span class="section_heading_style1">Payment Info:</span>
...
<td><input type="text" size="4" maxlength="7" name="amount" value="1.00" /> USD	</span></td>
                        ...
                        <tr valign="top">
                          <td valign="middle">Name: (as it appears on credit card)&nbsp;</td>
...
<td><input type="text" size="30" maxlength="32" name="lastName" value="Doe" /></span></td>
                          ...
                          <td valign="middle">Card Type:</td>
                          <td><input type="radio" id="creditCardType" name="creditCardType" value="Visa">
                        ...
                        <tr valign="top">
                          <td height="80">Special Instructions:</td>
                        ...
                        <tr valign="top">
                          ...
                          <td><img src="pix/pix_trans.gif" width="1" height="10">
                              <input name="submit" type="submit" value="Confirm Order"></td>
                        </tr>
                      </table></td>
                </tr>
              </table>
