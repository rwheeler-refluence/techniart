...
if(!$page || $page==1){
	...
	print("<br>");
	$ID=$_GET['ID'];
	$sql="select * from tblOrdersCompleted_statefarm where completeID='$ID'";
	$result=db_query($sql);
	...
	if(!$count){
		...
		while($row=mysql_fetch_array($result)){
			...
			print("<td><span class=\"body_content\">".$shipTo_street1." ".$shipTo_street2."<br>".$shipTo_city.",".$billTo_state." ".$shipTo_postalCode."</span></td>\n");
			print("</tr>\n");
			print("<tr valign=\"top\">");
			...
			$sql2="select * from tblotsdetail_statefarm where otsID='$otsID'";
