...
switch($action){
	case "add":
		...
		$sqlc="select * from tblorderstosend_facebook_test where sess='$sess' && status='open'";
		...
		$_SESSION['otsID']=$next;
		#add item to cart
		$sqli="select * from tblotsdetail_facebook_test where itemNo='$itemNo' && otsID='$next'";
		#print("".$sqli."<br />");
		$resulti=db_query($sqli);
		$counti=mysql_num_rows($resulti);
		if(!$counti){
			$sql2="insert into tblotsdetail_facebook_test values ('','$next','$itemNo','$quantity','$price','$desc')";
		}else{
			...
			$sql2="update tblotsdetail_facebook_test set qty='$newqty' where otsdetailID='$otsdetailID'";
		}
#		print($sql2);
...
<tr>
<td><div id="main_content_ip" align="left">
...
<form name="form1" id="form1" method="post" action="confirm_pre-facebook.php" onSubmit="return fVerifyResForm();"><input type="hidden" name="otsID" value="<? echo($o);?>">
...
<td colspan="2"><span class="body_content_style1"><br /></span></td>
</tr><tr valign="top">
<td width="120" valign="middle"><span class="body_content_style1">First Name:</span></td>
<td width="185"><input type="text" size="25" maxlength="100" name="fname" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td valign="middle"><span class="body_content_style1">Last Name:</span></td>
<td><input type="text" size="25" maxlength="100" name="lname" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td valign="middle"><span class="body_content_style1">Address 1:</span></td>
<td><input type="text" size="25" maxlength="100" name="address1" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td valign="middle"><span class="body_content_style1">Address 2:<br>(optional)</span></td>
<td><input type="text" size="25" maxlength="100" name="address2" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td valign="middle"><span class="body_content_style1">City:</span></td>
<td><input type="text" size="25" maxlength="40" name="city" value="" class="forms3" /></td>
</tr><tr valign="top">
<td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr><tr valign="top">
<td valign="middle"><span class="body_content_style1">State:</span></td>
...
<td valign="middle"><span class="body_content_style1">ZIP Code:</span></td>
<td valign="middle"><span class="body_content_style1"><input type="text" size="10" maxlength="10" name="zip" value="" class="forms2" />(5 or 9 digits)</span></td>
</tr>
<tr valign="top">
  <td colspan="2"><img src="pix/pix_trans.gif" width="1" height="5"></td>
</tr>
<tr valign="top">
  <td valign="middle"><span class="body_content_style1">Utility Company: </span></td>
  <td valign="middle"><select name="company" class="forms2">
    <option></option>
    <option value="NSTAR">NSTAR</option>
    <option value="NGRID">National Grid</option>
    <option value="WMECO">WMECO</option>
    <option value="CLC">Cape Light Compact</option>
  ...
  <tr valign="top">
    <td class="body_content_style1" colspan="3" align="left"><table width="592" border="0" align="left">
      <tr>
        <td width="298" height="52" class="body_content_style1"><div align="left">Would you like to receive emails from Mass Save about special deals and savings? </div></td>
        <td width="12"></td>
        <td width="268"><label>
...
</tr></table><table width="760" class="bkg_body-main">
<tr>
<td>
</td>
</tr></table>
