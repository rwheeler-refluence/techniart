...
<?
$sqlp="select * from tblProducts_facebook where productID='$ID'";
...
?>
        ...
        <form method="post" name="frm1" id="frm1" action="https://secure40.securewebsession.com/techniart.com/facebook/cart-facebook.php">
