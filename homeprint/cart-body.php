...
#		print("".$calcweight."<br>");
	...
	print("<tr>\n");
	print("<td align=\"right\"><img src=\"pix/pix_trans.gif\" width=\"400\" height=\"15\"><span class=\"body_content_style1\"><b>Subtotal:</b></span></td>\n");
...
#	print("</tr>\n");
	...
	print("</tr>\n");
	print("<tr>\n");
	print("<td colspan=\"3\" align=\"right\"><form method=\"post\" action=\"https://www.techniart.com/homeprint/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"hidden\" name=\"ship\" value=\"".$ship."\"><input type=\"hidden\" name=\"state\" value=\"".$_SESSION["shipping"]["state"]."\"><input type=\"submit\" value=\"Checkout\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
	print("</tr></form>\n");
	print("</table></form>\n");
		?>
</td>
