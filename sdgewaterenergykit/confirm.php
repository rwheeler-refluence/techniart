...
$sql="select * from tblTerritory where zip='$zip'";
#print("".$sql."<br>");
$result=db_query($sql);
$countzip=mysql_num_rows($result);
if($countzip<1){echo "<SCRIPT LANGUAGE='JavaScript'>
	window.alert('The service zip code you entered does not qualify!')
		window.location.href='https://www.techniart.us/sdgewaterenergykit/index.php'
        </SCRIPT>
        ";
		die();}
...
<body><?php include("analyticstracking.php") ?><form method="post" action="process.php">
<? include("header.php");?>
<!-- Begin content -->
<br>
<br>
