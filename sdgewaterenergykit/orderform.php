<? include("database.php");?><form name="form1" id="form1" method="post" action="https://www.techniart.us/sdgewaterenergykit/confirm.php" onSubmit="return fVerifyResForm();">
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
        ...
        <tr valign="top">
          ...
          <tr valign="top">
            ...
            <td align="left">&nbsp;</td>
                    ...
                    <tr valign="top">
                      <td colspan="2" align="center"><input required name="place" class="btn2" value="Confirm Order" type="submit"></td>
                    </tr>
