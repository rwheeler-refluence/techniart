...
$instr=$_POST['instr'];
	...
	$sql="insert into tblOrdersCompleted(stamp, fname, lname, streetnum, route, unit1, city, state, zip, zip4, email, ship_fname, ship_lname, ship_streetnum, ship_route, ship_unit1, ship_city, ship_state, ship_zip, ship_zip4, pledge, customer, swear)	values('$date','$fname','$lname', '$streetnum', '$route', '$unit1', '$city', '$state', '$zip', '$zip4', '$email', '$ship_fname', '$ship_lname', '$ship_streetnum', '$ship_route', '$ship_unit1', '$ship_city', '$ship_state','$ship_zip', '$ship_zip4','$pledge','$customer','$swear')";
	$result=db_query($sql);
...
function Redirect()
{
    window.location="http://www.techniart.us/sdgewaterenergykit/thanks.php";
}
