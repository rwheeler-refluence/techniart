...
<script type="text/javascript" src="http://ajax.googleapis.us/ajax/libs/jquery/1/jquery.js"></script>
...
<td width="906" class="title_bkg"><div id="title_spacer" align="left"><span class="cp_title">PRODUCT DETAILS</span></div></td>
</tr></table>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."dcseu/pix/products/".$imageLoc;
...
<form method="post" action="https://www.techniart.us/dcseu/cart.php">
<input type="hidden" name="action" value="add">
<input type="hidden" name="productID" value="<? echo($productID);?>">
<td width="170"><a rel="shadowbox;" href="pix/products/<? echo($imageLoc);?>" class="option" title="<? echo($productName);?>"><img src="pix/products/<? echo($imageLoc);?>" alt="<? echo($productName);?>" width="200" height="<? echo($height);?>" border="0" class="img_stroke"></a><br>
<? 
if($energy_star=='Yes'){
...
<?}?>&nbsp;&nbsp;<a href="http://www.techniart.us/dcseu/store-cat.php?cat=LED%20Products"><img src="pix/go_back.gif" width="83" height="27"></a>
<br></span></td>
...
<td width="1" bgcolor="#57aeca"><img src="pix/pix_000000.gif" alt="" width="1" height="1" border="0"></td>
</tr></table></td>
</tr></table>
