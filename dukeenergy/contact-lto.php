...
<div class="gridContainer clearfix">
  <div id="LayoutDiv1"><? include("header-order.php")?></div>
<!-- ------------------------------end header------------------------------ -->
...
<tr valign="top">
	<td width="100%"><span class="cart-header" style="margin-left: 1%">Contact form</span></td></tr>
<tr valign="top">
<td width="75%"><div id="" style="margin-left: 1%">
<?
$msg=$_GET['msg'];
if($msg=='security'){
...
<table width="70%" border="0" cellspacing="0" cellpadding="0"><tr valign="top">
<td width="40%"><span class="cart-sm"><b>First Name:</b><br>
...
<table width="40%" border="0" cellspacing="0" cellpadding="0"><tr valign="top">
<td width="60"><span class="cart-sm"><b>State:</b><br /> 	
...
<td width="145"><span class="cart-sm"><b>Zip Code:</b><br /> 	
...
<td width="365"><span class="cart-sm">
<img src="pix/pix_trans.gif" alt="" width="1" height="5" border="0"><br>
...
<!--end security-->
<img src="pix/pix_trans.gif" alt="" width="1" height="5" border="0"><br>
<input type="button" class="btn1" name="submit" alt="Submit" border="0" value="Submit" onClick="this.form.submit();"><br>
<br>
