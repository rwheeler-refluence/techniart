...
switch($action){
	case "add":
		...
		$sqlc="select * from tblorderstosend_1 where sess='$sess' && status='open'";
		...
		$_SESSION['otsID']=$next;
		#add item to cart
		$sqli="select * from tblotsdetail_1 where itemNo='$itemNo' && otsID='$next'";
		#print("".$sqli."<br />");
		$resulti=db_query($sqli);
		$counti=mysql_num_rows($resulti);
		if(!$counti){
			$sql2="insert into tblotsdetail_1 values ('','$next','$itemNo','$quantity','$price','$desc')";
		}else{
			...
			$sql2="update tblotsdetail_1 set qty='$newqty' where otsdetailID='$otsdetailID'";
		}
#		print($sql2);
...
$(document).ready(function() {
    ...
    function close_accordion_section() {
        $('.accordion .cart-header').removeClass('active');
...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js"></script>
<link rel="stylesheet" type="text/css" href="https://www.techniart.us/duke-lto/js/shadowbox.css">
<script type="text/javascript" src="https://www.techniart.us/duke-lto/js/shadowbox.js"></script>
<script type="text/javascript">
Shadowbox.init();
</script>
<meta charset="utf-8">
...
</head><?php include_once("analyticstracking.php") ?><?php include("nav.php") ?>
<BODY>
...
if(!$count){
	...
	print("<span class=\"cart-header\"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Order Form</b></span><br><br>\n");
...
if ($carttot >=15){
	...
	print("<tr bgcolor=\"#cccccc\">\n");
	print("<td colspan=\"4\" align=\"right\"><span class=\"cart\"><b>Shipping:</b>&nbsp;</td>\n");
	print("<td style=\"padding-left:4px;\"><span class=\"cart\">$".number_format($rate, 2, '.', ',')."</td>\n");
	#print("<td colspan=\"4\" align=\"right\"><span class=\"cart-header\"><b>Shipping:&nbsp;&nbsp;<span class=\"cart-header1\">$".$rateformat."</span>&nbsp;&nbsp;&nbsp;</td>\n");
	print("</tr>\n");
	print("<tr bgcolor=\"#cccccc\">\n");
		$finaltot=$carttot+$rate;
	print("<td colspan=\"4\" align=\"right\"><span class=\"cart\"><b>Total:</b>&nbsp;</td>\n");
	print("<td style=\"padding-left:4px;\"><span class=\"cart\">$".number_format($finaltot, 2, '.', ',')."</td>\n");
	#print("<td colspan=\"4\" align=\"right\"><span class=\"cart-header\"><b>:&nbsp;&nbsp;<span class=\"cart-header1\">$".$finaltot."</span>&nbsp;&nbsp;&nbsp;</td>\n");
	print("</tr>\n");}
	#print("<tr>\n");
...
<input type="hidden" name="source" value="<? echo($ship);?>">
<center><div align="center"><span class="body_content_ip"> <br>
ORDERS WILL ONLY BE SHIPPED TO RESIDENTIAL ELECTRIC CUSTOMERS OF DUKE ENERGY PROGRESS.<br>
  <br>
</div>
        ...
        <table width="100%"  align="left" border="0" cellpadding="0" cellspacing="0" style="margin-left: 2%">
          
          <tr align="top">
          <td align="left"><span class="cart-header">Shipping Information</span></td><td></td></tr>
          <tr align="top">
          <td align="left"><span class="cart">* Required fields</span></td><td></td></tr>
          <tr valign="top">
    ...
    <td align="left"><input required type="text" name="ship_city" id="ship_city" class="forms10" />
         ...
         <tr valign="top">
          ...
          <tr valign="top">
            ...
            <td align="left">
              <input required type="text" size="7" maxlength="7" name="ship_zip" value="" class="forms10" />
              </td>
          </tr>
         <tr valign="top">
            <td height="5"></td>
        ...
        <br>
         ...
         <table width="100%"  align="left" border="0" cellpadding="0" cellspacing="0" style="margin-left: 2%">
           <tr align="top">
          <td align="left"><span class="cart-header">Billing Information</span></td><td></td></tr>
          <tr align="top">
          <td align="left"><span class="cart">* Required fields</span></td><td></td></tr>
          <tr valign="top">
          <tr valign="top">
	 ...
	 <table width="100%"  align="left" border="0" cellpadding="0" cellspacing="0" style="margin-left: 2%">
           <tr align="top">
          <td align="left"><span class="cart-header">Payment Information</span></td><td></td></tr>
          <tr align="top">
          <!--<tr valign="top">
