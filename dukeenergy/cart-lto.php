...
print("<form  method=\"post\" action=\"".$PHP_SELF."\">\n");
	...
	while($row=mysql_fetch_array($result)){
		...
		print("<td align=\"center\"><input type=\"button\" class=\"btn2\" value=\"Update\" onClick=\"this.form.submit();\"> <input type=\"button\" class=\"btn2\" value=\"Remove\" onClick=\"location.href='remove-lto.php?ID=".$otsdetailID."'\"></td>\n");
...
#	print("</tr>\n");
	...
	print("</tr></form>\n");
	print("<tr>\n");
	print("<td colspan=\"5\" align=\"right\"><input type=\"button\" class=\"btn1\" value=\"Empty Cart\" onclick=\"location.href='empty-lto.php?otsID=".$o."'\"></td>\n");
	print("</tr>\n");
		#print("<tr>\n");
	...
	print("<tr>\n");
	if($PQ1 > '2'){
	print("<td colspan=\"5\" align=\"right\" class=\"cart\">In order to checkout, please adjust your cart to <b>2 total BR30 6-packs
 or less</b>.</td>\n");	
	print("</tr>\n");
	...
	if($canlimit > '2'){
	print("<td colspan=\"5\" align=\"right\" class=\"cart\">In order to checkout, please adjust your cart to <b>2 total 3-way 2-packs or less</b>.</td>\n");	
	print("</tr>\n");
	print("<tr height='25px'><td></td></tr>\n");
	print("</table>\n");
	}else{
		print("<td colspan=\"5\" align=\"right\"><form method=\"post\" action=\"orderform-lto.php\"><input type=\"hidden\" name=\"source\" value=\"".$source."\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"hidden\" name=\"ship\" value=\"".$ship."\"><input type=\"hidden\" name=\"state\" value=\"".$_SESSION["shipping"]["state"]."\"><input type=\"submit\" class=\"btn1\" value=\"Checkout\"></td>\n");
	print("</tr></form>\n");
