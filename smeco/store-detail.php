...
<html>
<head>
<title>TechniArt - SMECO Online Sale</title>
...
<?
$sqlp="select * from tblProducts_smeco where productID='$ID'";
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."SMECO/pix/products/".$imageLoc;
...
if($replacement_bulb){
	...
	for($r=0;$r<count($split);$r++){
			...
			$sqlnum="select productID,productName from tblProducts_smeco where modelNumber='$mf_nbr'";
