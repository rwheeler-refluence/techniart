...
<html>
<head>
<title>TechniArt - Kohler Online Sale</title>
...
<?
$sqlp="select * from tblProducts_foe where productID='$ID'";
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."kohler/pix/products/".$imageLoc;
...
if($replacement_bulb){
	...
	for($r=0;$r<count($split);$r++){
			...
			$sqlnum="select productID,productName from tblProducts_foe where modelNumber='$mf_nbr'";
