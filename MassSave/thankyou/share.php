...
$(function() {  
      $( "#share" ).click(function() {
          ...
          FB.ui(
            {
              method: 'feed',
              name: 'Four-Day Only LED Flash Sale!',
			  redirect_uri: 'http://www.techniart.us/masssave/thankyou/closewindow.php',
			  link: 'http://bit.ly/2nzRMhR',
              picture: 'https://techniart.us/fb.jpg',
			  caption: ' TechniArt.us/MassSave ',
              description: 'Find the perfect LEDs for your indoor track and recessed lighting – only $10 per pack! Sale ends 5/14 or while supplies last.'
            },
            function(response) {
    ...
    <table width="412" border="0">
      ...
      <tr>
        <td width="200" align="center"><a href="https://twitter.com/share" class="twitter-share-button" data-text="Choose among three sizes of indoor LED floodlights – only $10 per pack! Sale ends 5/14. pic.twitter.com/56NDxDgh02" data-url="http://bit.ly/2nY1m1w">Tweet</a>
