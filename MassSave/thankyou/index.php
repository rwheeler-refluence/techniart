...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="ty.jpg" usemap="#Map" border="0">
      ...
      <map name="Map">
        <area id="share2" shape="rect" coords="584,136,712,177" href="#" onClick="javscript:window.open('share.php','popup2a','scrollbars=no, resizeable=no,width=450,height=100,screenY=450,top=40, left=420');" alt="Facebook Share">
      </map></td></tr>
</table>
