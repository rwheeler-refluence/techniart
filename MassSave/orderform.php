...
if(!$count){
	...
	while($row=mysql_fetch_array($result)){
		...
		print("<td align=\"center\"><input type=\"button\" value=\"Go Back\" onClick=\"location.href='cart2.php'\" class=\"btn2\"></td>\n");
...
ORDERS WILL ONLY BE SHIPPED TO RESIDENTIAL ELECTRIC CUSTOMERS OF PARTICIPATING MASS SAVE SPONSORS.<br>
  ...
  <td align="left"><input name="account" id="account" type="text" size="25" value="" class="forms10"></td>
            ...
            <td height="5"></td>
                    ...
                    <tr valign="top"><td height="39" align="left"><span class="cart">After purchasing and installing the bulbs from this sale, what percent of lighting in your home will use LEDs?</span></td>
          ...
          <tr valign="top">
            <td height="5"></td>
                    ...
                    <tr valign="top"><td height="39" align="left"><span class="cart">How old is your dehumidifier?</span></td>
            <td valign="middle" align="left"><select name="question2" class="forms10">
             <option></option>
              <option value="Less than 5 years">Less than 5 years</option>
              <option value="5-10 years">5-10 years</option>
               <option value="More than 10 years">More than 10 years</option>
                <option value="Don’t own a dehumidifier">Don’t own a dehumidifier</option>
