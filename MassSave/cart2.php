...
if (mysql_num_rows($product3)) {
    ...
    $PQ3=$P3['qty']*1;}
	$limit=$PQ1+$PQ2+$PQ3;
	$product4 = mysql_query("SELECT qty FROM tblotsdetail WHERE otsID = '$o' && itemNo='245' ");
...
#	print("</tr>\n");
	...
	if($PQ4 < '1'){
	   print("<tr>\n");
	print("<td colspan=\"5\" align=\"right\"><input type=\"hidden\" value=\"1\" name=\"qty\"><input type=\"button\" class=\"btn1\" value=\"Add 1 APS\" onclick=\"location.href='addsw1.php'\"></td>\n");
	print("</tr>\n");}
	print("<tr>\n");
	...
	print("<tr>\n");
	if($limit > '2'){
	print("<td colspan=\"5\" align=\"right\" class=\"cart\"><br>In order to checkout, please adjust your cart to <strong>2</strong> LED Packs or fewer, and <strong>2</strong> Tier 1 Advanced Power Strips or fewer.</td>\n");	
	print("</tr>\n");
	print("<tr>\n");
	print("</table>\n");
	}else{
