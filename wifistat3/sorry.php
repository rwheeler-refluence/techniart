    ...
    <table width="100%" border="0">
        <tr>
          <td align="left"><span class="cart"><br>
            ...
            <p class="cart">Sorry, this Nest Wifi Thermostat offer is only available to National Grid residential gas customers in Upstate New York. 
              Nest units from this offer will only be shipped to qualifying ZIP codes within Upstate New York.<br>
              <br>
If you have any questions regarding your eligibility, please send an email to: <a href="mailto: customerservice@techniart.com">customerservice@techniart.com</a></p>
            ...
            <p class="cart">If you are a Long Island customer, <a href="http:/www.techniart.us/wifistat2">please use this portal.</a><br>
             ...
             <p class="cart">If you are a NYC customer, <a href="http://www.techniart.us/wifistat1">please use this portal.</a><br>
            </p>
</td>
        </tr>
