...
<?
$o=$_SESSION['otsID'];
$sql="select * from tblotsdetail LEFT OUTER JOIN tblProducts_raytheon on tblotsdetail.itemNo=tblProducts_raytheon.productID where tblotsdetail.otsID='$o'";
#print($sql);
$result=db_query($sql);
...
#	print("</tr>\n");
	...
	print("</tr></form>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><a class=\"body_content_style1\" href=\"http://www.techniart.com/nstar/empty.php?otsID=".$o."\">Empty Cart</a></td>\n");
	print("</tr>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><a class=\"body_content_style1\" href=\"http://www.techniart.com/nstar/index.php\">Continue Shopping</a></td>\n");
	print("</tr>\n");
	print("<tr>\n");
	print("<td colspan=\"4\" align=\"right\"><form method=\"post\" action=\"https://secure40.securewebsession.com/techniart.com/nstar/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"hidden\" name=\"ship\" value=\"".$ship."\"><input type=\"hidden\" name=\"state\" value=\"".$_SESSION["shipping"]["state"]."\"><input type=\"submit\" value=\"Checkout\"></td>\n");
	print("</tr></form>\n");
	print("</table></form>\n");
}	?>
<br>
