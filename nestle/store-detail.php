...
<html>
<head>
<title>TechniArt - Nestle Online Sale</title>
...
<?
$sqlp="select * from tblProducts_nestle where productID='$ID'";
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."nestle/pix/products/".$imageLoc;
...
if($replacement_bulb){
	...
	for($r=0;$r<count($split);$r++){
			...
			$sqlnum="select productID,productName from tblProducts_nestle where modelNumber='$mf_nbr'";
