...
$sqlcount="select * from tblVendors order by stamp desc";
$resultcount=db_query($sqlcount);
$numrows=mysql_num_rows($resultcount);
$numpages=ceil($numrows/$limitvalue);

		$sql="select * from tblVendors order by stamp desc limit $limit,$limitvalue";
		$result=db_query($sql);
