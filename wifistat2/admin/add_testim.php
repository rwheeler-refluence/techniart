...
if($action=='add'){
	...
	$sql="insert into tblTestim values ('','$testimFrom','$testimText','No')";
	$result=db_query($sql);
...
<td><span class="title_main_sub">Testimonial:</span>&nbsp;&nbsp;<span class="title_sub_level2">Add Testimonial</span><br></td>
<td align="right">&nbsp;</td>
</tr><tr>
...
<img src="pix/pix_trans.gif" alt="" width="1" height="8" border="0"><br>
<input type="submit" name="Submit" value="Add Testimonial"></form>
<br>
