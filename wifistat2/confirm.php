...
$company=("NGRID Nest Long Island");
...
<table width="100%">
  <tr valign="top">
    <td><span class="cart-header">Service Address:</span></td></tr>
  <tr valign="top">
    <td><span class="cart"><? echo($sfname); ?> <? echo($slname); ?></span><br>
      <span class="cart"><? echo($saddress1); ?>&nbsp;<? echo($saddress2); ?></span><br>
      <span class="cart"><? echo($scity); ?>, <? echo($sstate); ?> <? echo($szip); ?></span><br>
      <br>
