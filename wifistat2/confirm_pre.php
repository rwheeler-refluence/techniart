...
$sql="select * from tblTerritory2 where zip='$ship_zip'";
#print("".$sql."<br>");
$result=db_query($sql);
$countzip=mysql_num_rows($result);
if($countzip<1){echo "<SCRIPT LANGUAGE='JavaScript'>
	window.alert('The shipping zip code you entered is not a qualified Long Island zip code!')
		window.location.href='orderform.php'
        </SCRIPT>
        ";
		die();}
...
<?
$o=$_POST['otsID'];
$sql2="update tblotsdetail2 set orderinfo='$order' where otsID='$o'";
