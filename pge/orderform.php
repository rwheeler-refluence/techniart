...
<center><div align="center"><span class="body_content_ip">
  <br>
</div>

        <a class="accordion-section-title" href="#accordion-1">Shipping address</a>
    ...
    <td align="left"><input type="text" name="ship_city" id="ship_city" class="forms10" />
        ...
        <a class="accordion-section-title" href="#accordion-2">Billing address</a>
        ...
        <a class="accordion-section-title" href="#accordion-3">Payment information</a>
