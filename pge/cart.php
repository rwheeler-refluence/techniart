...
while($row=mysql_fetch_array($result)){
		...
		print("<td></td>\n");
 	 			print("<td></td>\n");
			print("<td></td>\n");
		print("<td align=\"center\"><form method=\"post\" action=\"https://www.techniart.us/pge-old/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Checkout\" class=\"btn1\">");
		print("</tr>\n");
		print("<tr><td><br></td></tr>\n");
		print("</table></form>\n");
}	?>
