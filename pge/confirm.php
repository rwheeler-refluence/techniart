  ...
  <tr valign="top">
    <td align="left"><span class="cart"><strong>Name on card:</strong> <? echo($firstName); ?> <? echo($lastName); ?></span><br>
      ...
      <span class="cart"><b>Special instructions:</b> <? echo($instr); ?></span></td>
        ...
        <tr valign="top">
<td colspan="2" align="center"><br><div align="center"><input type="hidden" name="amount" value="<? echo($finaltot); ?>"><input type="button" class="btn" value ="Place Order" onClick="this.form.submit();" /></div><br><strong class="cart">Please click the button once to avoid duplicate charges.</strong></span></td>
</tr></table></form>
<?}?>
