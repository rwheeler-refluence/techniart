...
function getGenericDefault($def) {
    ...
    // Your company name
    $a['shipper'] = 'Techniart, Inc.';

    // Key shipping contact individual at your company
    $a['shipContact'] = "Katie";

    $a['shipAddr1'] = '41 Bridge Street';
    $a['shipAddr2'] = '';
    $a['shipCity'] = 'Collinsville';
...
function getFEDEXDefault($def) {
    ...
    // SHIPPER_REFERENCE
    // STANDARD_MPS
    $a['trackingIdType'] = 'TRACKING_NUMBER_OR_DOORTAG';
...
function getUPSDefault($def) {
    ...
    $a['license'] = '9CC745C91D824936';

    // your UPS Developer username
    $a['username'] = 'techniart';
    ...
    $a['packageDescription'] = 'Techniart, Inc Shipment';

    // Set '0' for commercial '1' for residential
    $a['residentialAddressIndicator'] = '1';
...
/**
* This function is used to set Stamps.com specfic defaults.
*
* These defaults will be used for Stamps.com calls only.  They can be 
* overwritten on the 
* shipment/package level using the setParameter() function.
*/
function getSTAMPSDefault($def) {
    $a = array();
...
//{{PUROLATOR
function getPUROLATORDefault($def) {
    $a = array();

    $a['username'] = 'd8f7f02fd3ea43d58b556ebb75d5674e';
    $a['password'] = 'lio^}Y!+';
    $a['accountNumber'] = '9999999999';

    // lb or kg
    $a['weightUnit'] = 'lb';

    // DropOff or PreScheduled
    $a['pickupType'] = 'PreScheduled';

    $a['service'] = 'PurolatorExpress';
