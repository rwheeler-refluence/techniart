    ...
    <table width="100%" border="0">
        <tr>
          <td align="left"><span class="cart"><br>
            ...
            <p class="cart">Sorry, this offer is only available to residential electric customers. 
              
              Kits from this offer will only be shipped to qualifying ZIP codes within Colorado.<br>
              <br>
If you have any questions regarding your eligibility, please send an email to: <a href="mailto: customerservice@techniart.com">customerservice@techniart.com</a></p>
            <p class="cart">Please include your name and address to help us verify your eligibility with BPA.</p>
            <p class="cart"><br>
            </p>
</td>
        </tr>
