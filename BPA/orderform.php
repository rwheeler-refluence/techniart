...
ORDERS WILL ONLY BE SHIPPED TO RESIDENTIAL ELECTRIC CUSTOMERS OF PARTICIPATING MASS SAVE SPONSORS.<br>
  <br>
</div>
  ...
  <td align="left"><input name="account" id="account" type="text" size="25" value="" class="forms10"></td>
            ...
            <td height="5"></td>
                             ...
                             <tr valign="top"><td height="39" align="left"><span class="cart">What type of water heater do you have? *</span></td>
          <td valign="middle" align="left"><select required name="water" class="forms10">
             <option></option>
            ...
            <td height="5"></td>
                    ...
                    <tr valign="top"><td height="39" align="left"><span class="cart">How many people live in your household? </span></td>
            <td valign="middle" align="left"><select name="question1" class="forms10">
             <option></option>
          ...
          <tr valign="top">
            <td height="5"></td>
                    ...
                    <tr valign="top"><td height="39" align="left"><span class="cart">Where do you typically shop for light bulbs? </span></td>
            <td valign="middle" align="left"><select name="question2" class="forms10">
             <option></option>
              <option value="Home improvement store (i.e. Lowe’s, Home Depot)">Home improvement store (i.e. Lowe's, Home Depot)</option>
