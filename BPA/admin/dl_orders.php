...
$out.="\"ID\",\"Date\",\"Ship First\",\"Ship Last\",\"Ship Address\",\"Ship Address 2\",\"Ship City\",\"Ship State\",\"Ship Zip\",\"Instructions\",\"Bill First\",\"Bill Last\",\"Bill Address\",\"Bill Address 2\",\"Bill City\",\"Bill State\",\"Bill Zip\",\"Email\",\"Last LED\",\"Account\",\"Heat Water\",\"Source\",\"Tax\",\"Total\",\"Bathroom Kit\"\n";
...
$combo="select qty as ComboQuantity from tblotsdetail where otsID='$otsID' && itemNo='243' && qty>'0'";
...
$handheld="select qty as handheldQuantity from tblotsdetail where otsID='$otsID' && itemNo='244' && qty>'0'";
$resulthandheld=db_query($handheld);
$countrows=mysql_num_rows($resulthandheld);
if($countrows>0){
while($row=mysql_fetch_array($resulthandheld))
{$handheldlimit=$row['handheldQuantity'];}}else{
$handheldlimit='0';}

$out.="\"".$completeID."\",\"".$timestamp."\",\"".$ship_firstname."\",\"".$ship_lastname."\",\"".$ship_address."\",\"".$ship_address2."\",\"".$ship_city."\",\"".$ship_state."\",\"".$ship_zip."\",\"".$instructions."\",\"".$bill_firstname."\",\"".$bill_lastname."\",\"".$bill_address."\",\"".$bill_address2."\",\"".$bill_city."\",\"".$bill_state."\",\"".$bill_zip."\",\"".$email."\",\"".$email_opt."\",\"".$account."\",\"".$water."\",\"".$source."\",\"".$tax."\",\"".$amount."\",\"".$combolimit."\",\"".$handheldlimit."\"\n";
		}
