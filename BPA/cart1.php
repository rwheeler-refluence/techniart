...
if(!$count){
	print("<br><p align=\"center\"><b>Only 2 Energy Saving Starter Sets may be purchased per residential address.</b></p><br />\n");
...
while($row=mysql_fetch_array($result)){
        ...
        print("<td align=\"center\"><input type=\"text\" class=\"forms7\" name=\"qty[]\" size=\"3\" value=\"".$qty."\"></span></td>\n");
		...
		print("<td></td>\n");
		print("<td></td>\n");
print("<td align=\"center\"><input type=\"submit\" value=\"Update\" onClick=\"this.form.submit();\" class=\"btn1\"></td></form></tr>\n");
		print("<tr><td><br></td></tr>\n");
		print("<tr>\n");
		print("<td></td>\n");
 	 	print("<td></td>\n");
			print("<td></td>\n");
		print("<td align=\"center\"><form method=\"post\" action=\"https://www.techniart.com/Eversource/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Checkout\" class=\"btn1\">");
		print("</tr>\n");
		print("<tr><td><br></td></tr>\n");
		print("</table></form>\n");
}	?>
