...
if(!$count){
	print("<br><p align=\"center\"><b>Only 2 Embertec EmberStrip AVs may be purchased per residential address.</b></p><br />\n");
...
while($row=mysql_fetch_array($result)){
		...
		print("<td></td>\n");
 	 			print("<td></td>\n");
			print("<td></td>\n");
		print("<td align=\"center\"><form method=\"post\" action=\"https://www.techniart.com/masssave-rac/orderform.php\"><input type=\"hidden\" name=\"otsID\" value=\"".$o."\"><input type=\"submit\" value=\"Checkout\" class=\"btn1\">");
		print("</tr>\n");
		print("<tr><td><br></td></tr>\n");
		print("</table></form>\n");
}	?>
