...
<? include("header-combo.php");?>
  ...
  <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td height="379" valign="bottom" background="combo.jpg"><div align="right">
          <?
$sqlp="select * from tblProducts_eversource where productID='$ID'";
...
?>
        ...
        <form method="post" action="https://www.techniart.com/eversourcema/cart.php">
...
?>
  ...
  <table width="900" border="1" align="center">
    ...
    <tr>
      <td height="42" colspan="2" align="center"><strong class="style1">Limit of (2) Combos per residential account</strong></td>
    </tr>
    <tr>
      <td width="420" height="213"><div align="center"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"><img src="tcp-led-a19.jpg" width="70" height="130"></div></td>
      <td width="464" align="left"><div align="center" class="style1">6 - 60 watt equivalent 
        Omni-directional<br>
    ...
    <tr>
      <td height="260" align="center"><img src="globe.jpg" width="165" height="300"></td>
      <td align="left"><div align="center" class="style1">1 - 40 watt equivalent 
        LED Desk Lamp</div>
        <ul>
          <li>
            <div align="left">5w usage = 40 watt equivalent output</div>
          </li>
          <li>
            <div align="left">25,000 hour lifetime</div>
          </li>
