...
<html>
<head>
<title>TechniArt - LED 4 Pack</title>
  ...
  <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td height="379" valign="bottom" background="combo.jpg"><div align="right">
          <?
$sqlp="select * from tblProducts_ui where productID='$ID'";
...
?>
        ...
        <form method="post" action="https://www.techniart.com/simsmm/cart.php">
...
?>
  ...
  <table width="900" border="1" align="center">
    ...
    <tr>
      <td height="42" colspan="2" align="center"><strong class="style1">Limit of (4) LED 4-packs per 
        order (total of 16 LEDs)</strong></td>
    </tr>
    <tr>
