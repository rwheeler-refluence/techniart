...
if ($APSlimit>2){echo "<SCRIPT LANGUAGE='JavaScript'>
        window.alert('You have exceeded the limit of APS allowed.')
		window.location.href='cart.php'
        </SCRIPT>";}
if ($combolimit>2){echo "<SCRIPT LANGUAGE='JavaScript'>
        window.alert('You have exceeded the limit of Home Efficiency Kits allowed.')
		window.location.href='cart.php'
        </SCRIPT>";}
?>
<center>
