...
<html>
<head>
<title>TechniArt - Microsoft Online Sale</title>
...
while($rowp=mysql_fetch_array($resultp)){
	...
	$productPub=$rowp['productPub'];
			$loc=$rootDir."microsoft/pix/products/".$imageLoc;
...
if($replacement_bulb){
	...
	for($r=0;$r<count($split);$r++){
			...
			$sqlnum="select productID,productName from tblProducts_pse where modelNumber='$mf_nbr'";
