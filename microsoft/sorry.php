...
<tr>
    <td valign="top"><table width="766" border="0" align="center">
      <tr>
        <td width="760" height="51" colspan="5"><div align="center">
          <p>&nbsp;</p>
          <p><span class="section_heading_style1"><br />
            Sorry, this promotion is only available to residential electric customers of Green Mountain Energy. <br>
            <br>
            If you have any questions in regards to your eligibility, please send an email to: <a href="mailto:customerservice@techniart.com">customerservice@techniart.com</a>.</span><br>
          </p>
          <p>&nbsp;</p>
          <p><br>
            <br>
