...
#fulfillment e-mail
$to="harvard-orders@techniart.com";
#$to="george@crucialnetworking.com";
$from="sales@techniart.com";
$subject="Harvard Residence Limited Time Offer Order - techniart.com";
...
Offer good from Tuesday, October 8th through Wednesday, October 22nd. Customers must pick up their order at their selected pickup location.  Orders will not be shipped.

We will notify you by email if any item in your order will be delayed or if it is backordered.  TechniArt and Harvard are not responsible for misdirected or undeliverable packages.  If your package is returned as misdirected or undeliverable we will work with you to set up an alternate shipping option.
