...
if(!$page || $page==1){
	...
	print("<br>");
	$ID=$_GET['ID'];
	$sql="select * from tblOrdersCompleted_eversource where completeID='$ID'";
	$result=db_query($sql);
	...
	if(!$count){
		...
		while($row=mysql_fetch_array($result)){
			...
			print("</tr>\n");
			print("<tr valign=\"top\">");
			print("<td bgcolor=\"#eaeef4\"><span class=\"body_content\"><b>Office Location</b></span></td>\n");
			print("<td><span class=\"body_content\">".$shipTo_country."</span></td>\n");
			print("</tr>\n");
			print("<tr valign=\"top\">");
			...
			$sql2="select * from tblotsdetail_eversource where otsID='$otsID'";
