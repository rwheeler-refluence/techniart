...
$sqlcount="select * from tblAuditSignup order by stamp desc";
$resultcount=db_query($sqlcount);
$numrows=mysql_num_rows($resultcount);
$numpages=ceil($numrows/$limitvalue);

		$sql="select * from tblAuditSignup order by stamp desc limit $limit,$limitvalue";
		$result=db_query($sql);
		...
		while($row=mysql_fetch_array($result)){
			...
			print("</span></td>");
			print("<td><img src=\"pix/b_view_details.png\" alt=\"\" width=\"16\" height=\"16\">&nbsp;<a class=\"body_content\" href=\"audit_detail.php?ID=".$contactID."\">View Details</a><br><img src=\"pix/b_delete.png\" alt=\"\" width=\"16\" height=\"16\" border=\"0\">&nbsp;<a class=\"body_content\" href=\"#\" ONCLICK=\"javascript:decision('Are you sure you want to delete this entry?', 'del_contact.php?ID=".$contactID."')\">Delete</a>");
			print("</td>");
			print("</tr>\n");
		}
		print("</table><br>");
